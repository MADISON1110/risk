...
if res ~= 200 then
print('\27[0;31m≪━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m≪━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━≫ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'افتار'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "SO_AVT")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 AＶＡＴＡＲ𖤴")  
...
if text == "الغاء" or text == "الغاء 𖤓" then   
...
send(msg.chat_id_, msg.id_," 𖤓 تمت الاذاعه الى *~ "..#list.." ~* جروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤓 لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n  𖤓 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevSoFi(msg) then
local bl = ' 𖤓 اهلا عزيزي آلمـطـور\n 𖤓 آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n 𖤓 تسـتطـيع‌‏ آلتحگم باوامر البوت\n 𖤓 من خلاال الكيبورت خاص بك\n 𖤓 قناة سورس البوت [اضغط هنا](t.me/SO_AVT)'
local keyboard = {
...
SourceDRAGONr = '𖤓اهلا عزيزي\n𖤓انا بوت اسمي افتار\n𖤓اختصاصي حمايه الجروبات\n𖤓من تكرار والسبام والتوجيه والخ…\n𖤓لتفعيلي اتبع الاخطوات…↓\n𖤓اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[𖤓معرف المطور '
end 
...
local Text = ' 𖤓 تم ارسال الملصق من ↓\n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/mina226/avtar/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' 𖤓 تم تحديث السورس \n 𖤓 لديك اخر اصدار لسورس افتار\n 𖤓 الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 𖤓 اصدار سورس  افتار\n 𖤓 الاصدار »{ v 1.5}')
end
...
{{text = '𝑾𝑨𝒁𝑬𝑹 𝑬𝑳𝑨𝒁𝑴𝑨', url="t.me/DV_MI_NA2"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == '⩹━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━⩺' or text == '⩹━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━⩺' or text == '⩹━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━⩺' or text == '"' then
local Text =[[
تواصل السورس ☑️
]]
keyboard = {} 
...
{
{text = '𖤛  مبرمج ومطور السورس  𖤛 ', url = "https://t.me/DV_MI_NA2"},
},
{
{text = '𖤛 قناه السورس 𖤛', url = "https://t.me/SO_AVT"},
},
}
local msg_id = msg.id_/2097152/0.5
...
{
{text = '𖤛  مبرمج ومطور السورس  𖤛 ', url = "https://t.me/SO_AVT"},
},
{
{text = '𖤛 قنـاة السـورس 𖤛', url = "https://t.me/SO_AVT"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SO_AVT&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = '𖤛 قنات سورس متميزه  𖤛 ', url = "https://t.me/SO_AVT"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SO_AVT&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_,'• اهلا بك عزيزي 𖤓 •\n• لايمكنك استخدام البوت 𖤓 •\n• عليك الاشتراك في القناة 𖤓 •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'𖤓 لا يوجد جروبات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
DRAGON = '\n𖤓 تم ازالة » { '..q..' } جروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n𖤓 تم ازالة » {'..w..'} جروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'𖤓  عدد الجروبات الان » { '..#group..' }'..DRAGONk..''..DRAGON..'\n𖤓  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,' 𖤓 لا تستطيع استخدام البوت \n  𖤓 يرجى الاشتراك بالقناه اولا \n  𖤓 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
usertext = '\n 𖤓 العضو » ['..result.title_..'](t.me/'..(username or 'SO_AVT')..')'
status  = '\n 𖤓 تم ترقيته مطور'
...
usertext = '\n 𖤓 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_AVT')..')'
status  = '\n 𖤓 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤓 العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SO_AVT')..') \n 𖤓 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_," 𖤓 تمت الاذاعه الى >>{"..#list.."} جروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 𖤓 تمت الاذاعه الى >>{"..#list.."} جروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_,' 𖤓 عذا لا يمكنك وضع معرف جروب بالاشتراك ')
return false  end
...
send(msg.chat_id_, msg.id_,' 𖤓 تم تغيير صورة الجروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,' 𖤓 تم تغيير وصف الجروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤓 تم حفظ ترحيب الجروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_,0," 𖤓 العضو : {["..data.first_name_.."](T.ME/SO_AVT)}\n 𖤓 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 𖤓 عذرا » {["..data.first_name_.."](T.ME/SO_AVT)}\n 𖤓 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' 𖤓 عدد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖤓 بالتأكيد تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n 𖤓 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖤓 تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = ' 𖤓 تم تفعيل جروب جديده\n'..
'\n 𖤓 بواسطة {'..Name..'}'..
'\n 𖤓 ايدي الجروب {'..IdChat..'}'..
'\n 𖤓 اسم الجروب {['..NameChat..']}'..
'\n 𖤓 عدد اعضاء الجروب *{'..NumMember..'}*'..
'\n 𖤓 الرابط {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_,' 𖤓 بالتأكيد تم تعطيل الجروب')
else
sendText(msg.chat_id_,'\n 𖤓 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖤓 تم تعطيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖤓 تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n 𖤓 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖤓 تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' 𖤓 تم تعيين عدد الاعضاء سيتم تفعيل الجروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
if text == 'تحديث السورس' and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if text and text:match("^وضع قناة الاشتراك 𖤓$") and DevSoFi(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖤓 حسنآ ارسل لي معرف القناة')
return false  
end
...
send(msg.chat_id_, msg.id_, "𖤓 عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "SO_AVT")..")\n𖤓 عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."} بجانب اسمك\n𖤓 عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
𖤛- [اهلا بك في سورس افتار الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني ](t.me/SO_AVT) 𖤛
...
if text == 'مينا' or text == 'mina' or text == 'الوزير' or text == '"' then
local Text =[[


𖤛- [𖤛مـبـرمج السـورس 𖤛](t.me/DV_MI_NA2) 𖤛
...
if text == 'فوديكا' or text == 'Vodeka' or text == 'مطور السورس' or text == '"' then
local Text =[[
𖤛- [𖤛مطـور الســورس 𖤛](t.me/DV_Vo_Dk_A1) 𖤛
]]
keyboard = {} 
keyboard.inline_keyboard = {

{
{text = '𖤛  مبرمج ومطور السورس  𖤛 ', url = "https://t.me/DV_Vo_Dk_A1"},
},
{
{text = '𖤛 قنـاة السـورس 𖤛', url = "https://t.me/SO_AVT"},
},
...
"‏ ‏ممكن اكون اختارت غلط بس والله حبيت بجد🖇️",
"‏ علينا إحياء زَمن الرّسائل الورقيّة وسط هذه الفوضى الالكترونية العَارمة.𖤓💜",
...
"ويُرهقني أنّي مليء بما لا أستطيع قوله.✨",
"‏ من مراتب التعاسه إطالة الندم ع شيء إنتهى. 𖤓 ",
"‏ ‏كل العالم يهون بس الدنيا بينا تصفي 💙",
"‏ بعض الاِعتذارات يجب أن تُرفَضّ.",
"‏ ‏تبدأ حياتك محاولاً فهم كل شيء، وتنهيها محاولاً النجاة من كل ما فهمت.",
"‏ إن الأمر ينتهي بِنا إلى أعتياد أي شيء.",
...
local TWEET_Msg = { 
"‏𖤓 مرة واحد اتخانق هو ومراته بالليل ومابيكلموش بعض.. حط لها ورقة جنب السرير قال لها صحيني الصبح الساعة ستة ونص.. صحي الصبح بيبص ف الساعة لقى الساعة عشرة.. ولقى جنبه ورقة مكتوب فيها اصحى الساعة بقت ستة ونص. ", 
"‏𖤓 مره واحد بلديتنا كان بيدق مسمار فى الحائط فالمسمار وقع منه فقال له :تعالى ف مجاش, فقال له: تعالي ف مجاش. فراح بلديتنا رامي على المسمار شوية مسمامير وقال: هاتوه. ",
"‏ ‏𖤓 واحدة عملت حساب وهمي ودخلت تكلم جوزها منه.. ومبسوطة أوي وبتضحك.. سألوها بتضحكي على إيه؟ قالت لهم أول مرة يقول لي كلام حلو من ساعة ما اتجوزنا.",
"𖤓  مره اسكندراني دعك المصباح طلعله جني..   جاب بيه مستيكة.",
"‏ 𖤓 واحد بلدياتنا عمل 2 إيميل، واحد دوت كوم للشتاء وواحد نص كوم للصيف",
"‏ 𖤓 ﺻﻌﻴﺪي ﻟﻐﻲ ﻣﻮﻋﺪه ﻣﻊ اﻟﺪﻛﺘﻮر!   عشان كان ﻣﺮﻳﺾ.",
"‏𖤓 بيقولك مره واحد نام ساعه..    صحي لقى نفسه حظاظه..",
"‏ 𖤓 مره واحد اشترى فراخ..   علشان يربيها فى قفص صدره. .",
"‏ 𖤓 واحدة عملت حساب وهمي ودخلت تكلم جوزها منه.. ومبسوطة أوي وبتضحك.. سألوها بتضحكي على إيه؟ قالت لهم أول مرة يقول لي كلام حلو من ساعة ما اتجوزنا..",
"‏ ‏: 𖤓 مرة مهندس برمجة اتجوز وخلف بنتين توأم .. سمى واحدة لوجين والتانية Log out.",
"𖤓 واحد بلدياتنا عمل 2 إيميل، واحد دوت كوم للشتاء وواحد نص كوم للصيف",
"‏ 𖤓 مرة واحد اتخانق هو ومراته بالليل ومابيكلموش بعض.. حط لها ورقة جنب السرير قال لها صحيني الصبح الساعة ستة ونص.. صحي الصبح بيبص ف الساعة لقى الساعة عشرة.. ولقى جنبه ورقة مكتوب فيها اصحى الساعة بقت ستة ونص.",
"‏ ‏𖤓 واحد أخوه مات ومش عاوز يصدم مراته بالخبر مرة واحدة.. دخل عليها وقال لها: جوزك اتجوز عليكي.. صوتت وقالت إلهي أشوفه داخل ميت.. قال لأصحابه: دخلوه يا رجالة.",
} 
send(msg.chat_id_, msg.id_,'['..TWEET_Msg[math.random(#TWEET_Msg)]..']')  
return false 
end
...
if text == 'العاب افاتار' or text == 'العاب مسليه' or text == 'العاب متطوره' then  
local Text = [[  
...
if text == 'العاب صغيره' then
local Text = [[
AＶＡＴＡＲ𖤴
]]
keyboard = {} keyboard.inline_keyboard = {
{{text = 'AＶＡＴＡＲ𖤴', url="t.me/SO_AVT"}}, 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 𖤓 بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SO_AVT')..') \n 𖤓 تـم قفـل الدردشه ')
end,nil)   
...
Text = ' 𖤓 تم تفعيل امر @all'
database:del(bot_id..'Cick:all'..msg.chat_id_)  
else
Text = ' 𖤓 بالتاكيد تم تفعيل امر @all'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤓 بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SO_AVT')..') \n 𖤓 تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ?? بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SO_AVT')..') \n 𖤓 تـم فتح الاغاني ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n𖤓♯تم قفل البوتات بالطرد\n𖤓♯تم وضع الايدي بدون صوره\n𖤓♯تم قفل التكرار بالطرد\n𖤓♯تم قفل الروابط\n𖤓♯تم قفل التوجيه\n𖤓♯تم قفل الملصقات\n𖤓♯تم قفل المتحركه\n𖤓♯تم قفل الفيديو\n𖤓♯تم قفل السب\n𖤓♯تم قفل التعديل\n𖤓♯تم قفل الفارسيه\n𖤓♯تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه »>['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SO_AVT')..')')   
end,nil) 
end
...
send(msg.chat_id_, msg.id_,' ✰┇لم اجد صاحب الايدي') 
end 
end 
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil) 
end
...
if text == 'تفعيل الردود السورس' then
if "x" == "c"  then
send(msg.chat_id_, msg.id_,'𖤓 عليك الاشتراك بقناة السورس \n 𖤓 قناة السورس - [@SO_AVT] ') 
return false
end
if not Owner(msg) then
return send(msg.chat_id_,msg.id_,'*𖤓اهلا عزيزي \n عذرا الامر يخص - مدير - منشئ*')
end   
redis:del(bot_id..'Alex:Reply:Manager'..msg.chat_id_)  
return send(msg.chat_id_, msg.id_,'𖤓 تم تفعيل الردود') 
end
if text == 'تعطيل الردود السورس' then
if "x" == "c"  then
send(msg.chat_id_, msg.id_,'𖤓 عليك الاشتراك بقناة السورس \n 𖤓 قناة السورس - [@SO_AVT] ') 
return false
end
...
redis:set(bot_id..'Alex:Reply:Manager'..msg.chat_id_,true)  
...
Send_Options(msg,result.sender_user_id_,"reply","𖤛تم رفعه مميز عام𓍢\n𖤛 بواسطه ، "..renk_faeder(msg).."\n")
end 
...
usertext = '\n 𖤓 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_AVT')..')'
status  = '\n 𖤓 تم الغاء (الحظر-الكتم) عام من الجروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if Get_info then
local TextS = "\n 𖤓 اهلا بك في متجر ملفات افتار\n 𖤓 ملفات السورس ↓\n≪━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━≫\n 𖤓 علامة تعني { ✔️ } ملف مفعل\n 𖤓 علامة تعني { ✖ } ملف معطل\n 𖤓 قناة سورس افتار ↓\n".." 𖤓 [اضغط هنا لدخول](t.me/SO_AVT) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/mina226/avtar/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," 𖤓 عذرا الملف لايدعم سورس افتار\n") 
end
return false
end
...
send(msg.chat_id_, msg.id_,' 𖤓 لا ����ستطيع استخدام البوت \n  𖤓 يرجى الاشتراك بالقناه اولا \n  𖤓 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
function start_function(extra, result, success)
...
Text = ' 𖤓 بالتاكيد تم تفعيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤓 تم تعطيل امر تحويل'
else
Text = '\n 𖤓 بالتاكيد تم تعطيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_," 𖤓 منشئ الجروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
send(msg.chat_id_, msg.id_, ' 𖤓 تم مسح المنظفين')
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖤓 لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_AVT')..')'
status  = '\n 𖤓 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖤓 العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, ' 𖤓 تم مسح جميع المتوحدين')
end
if text == ("تاك للمتوحدين") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n 𖤓 قائمة متوحدين الجروب \n≪━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤓 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖤓 تم رفع العضو متوحد في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤓 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_AVT')..')'
status  = '\n 𖤓 تم تنزيل العضو متوحد في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤓 تم مسح جميع الزوجات')
end
if text == ("تاك للزوجات") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n 𖤓 قائمه زوجات الجروب \n≪━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
local  statuss  = '\n 𖤓 تم رفع العضــو زوجه في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤓 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_AVT')..')'
status  = '\n 𖤓 تم تنزيل العضــو الزوجات من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤓 تم مسح جميع الكلاب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤓 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖤓 تم رفع العضــو كلب في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤓 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_AVT')..')'
status  = '\n 𖤓 تم تنزيل العضــو كلب من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤓 تم تنزيل جميع حمير من الجروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤓 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_AVT')..')'
local  statuss  = '\n 𖤓 تم رفع المتهم حمار بالجروب\n 𖤓 الان اصبح حمار الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤓 تم تنزيل جميع وتكات الجروب')
end
if text == ("تاك للوتكات") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n 𖤓 قائمة وتكات الجروب \n≪━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' 𖤓 تم تنزيل جميع القرده بالجروب')
end
if text == ("تاك للقرود") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n 𖤓 قائمة القرود الجروب \n≪━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
-----------------------------------------------------
if text == 'مسح القلوب' and Mod(msg) then
database:del(bot_id..'Bro:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤓 تم تنزيل جميع الارامل بالجروب')
end
if text == ("تاك للقلوب") and Mod(msg) then
local list = database:smembers(bot_id..'Bro:User'..msg.chat_id_)
t = "\n 𖤓 قائمة ارامل الجروب \n≪━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» قلبـك ❤️ [@"..username.."]\n"
else
t = t..""..k.."» قلبـك ❤️ `"..v.."`\n"
end
end
...
send(msg.chat_id_, msg.id_, ' 𖤓 تم تنزيل جميع البقرات بالجروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n 𖤓 قائمة البقرات الجروب \n≪━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' 𖤓 تم تنزيل جميع المزز بالجروب')
end
...
send(msg.chat_id_, msg.id_, ' 𖤓 تم تنزيل جميع االاكساس')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤓  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_AVT')..')'
status  = '\n 𖤓  الايدي » `'..result.sender_user_id_..'`\n 𖤓  تم تنزيله ادمن من الجروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
linkgp = ' 𖤓 لا يوجد رابط ارسل ضع رابط'
end  
...
send(msg.chat_id_, msg.id_,' 𖤓 تم ازالة صورة الجروب') 
end
return false  
end
...
GetWelcome = ' 𖤓 لم يتم تعيين ترحيب للجروب'
end 
...
send(msg.chat_id_, msg.id_,' 𖤓 تم تفعيل ترحيب الجروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖤓 تم تعطيل ترحيب الجروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' 𖤓 تم ازالة ترحيب الجروب') 
end
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " 𖤓 لا توجد بوتات في الجروب")
else
...
local f = ' 𖤓 عدد البوتات التي هي ادمن >> {'..t..'}\n 𖤓 ملاحضه علامة ال (𖤓) تعني ان البوت ادمن \n'
...
send(msg.chat_id_, msg.id_," 𖤓 تم حفظ قوانين الجروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
if Mod(msg) then
send(msg.chat_id_, msg.id_," 𖤓 تم ازالة قوانين الجروب")  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖤓 العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SO_AVT')..')'..'\n 𖤓 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'𖤓تستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_, msg.id_,"𖤓 تم تنظيف جميع الميديا")
end
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'افتار')
local DRAGON_Msg = {
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖤓 ليست لدي صلاحية تغير اسم الجروب")  
else
sebd(msg.chat_id_,msg.id_,' 𖤓 تم تغيير اسم الجروب الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_," 𖤓 تم مسح الردود العامه")
end

if text == ("الردود العامه") and DevSoFi(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n 𖤓 قائمة الردود العامه \n≪━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━≫\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,"𖤓تم حذف ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_," 𖤓 تم مسح الردود")
end
...
local Text ='𖤓 تم اختيار المقطع الصوتي لك'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'AＶＡＴＡＲ𖤴 ',url="t.me/SO_AVT"}},
}
...
send(msg.chat_id_, msg.id_,'𖤓لا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\n 𖤓قم بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n𖤓 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_AVT')..') '
status  = '\n𖤓 الايدي » '..result.sender_user_id_..'\n𖤓تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖤓 البوت ليس مشرف يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤓  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_AVT')..')'
status  = '\n 𖤓  الايدي » `'..result.sender_user_id_..'`\n 𖤓  تم حذف لقبه من الجروب'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
send(msg.chat_id_, msg.id_,'𖤓وينك وين القب ') 
else
send(msg.chat_id_, msg.id_,'𖤓لقبك هو : '..GeId.result.custom_title) 
end
end
...
send(msg.chat_id_, msg.id_,'\n 𖤓صلاحيات البوت هي\n≪━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━≫\n𖤓  علامة ال {✔️} تعني مفعل\n𖤓  علامة ال {✖} تعني غير مفعل\n≪━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━≫\n𖤓تغير معلومات المجموعة ↞ '..INf..'\n𖤓حذف الرسائل ↞ '..DEL..'\n𖤓حظر المستخدمين ↞ '..REs..'\n𖤓دعوة المستخدمين ↞ '..INv..'\n𖤓ثتبيت الرسالة ↞ '..Pin..'\n𖤓اضافة مشرفين ↞ '..PRo)   
end
end
if text == "تعطيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_, '𖤓 تم تعطيل الانستا')
database:set(bot_id.."SO_AVT:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'𖤓 تم تفعيل الانستا')
database:set(bot_id.."SO_AVT:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."SO_AVT:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."SO_AVT:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"𖤓تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."SO_AVT:Tag:Admins:"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "𖤓تم تعطيل تاك المشرفين")
end

if text == 'صيح المشرفين' or text == "تاك للمشرفين" or text == "وين المشرفين" or text == "المشرفين" then
if database:get(bot_id.."SO_AVT:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس افتار يعني لو بكتهن راح اعرفك انت الاخذتهن
local t = "\n𖤓المستخدم ~ ["..User_id .."] يصيح المشرفين \n≪━━━━━━ AＶＡＴＡＲ𖤴 ━━━━━━≫\n"
k = 0
...
return send(msg.chat_id_, msg.id_,"𖤓ارسل الرد الذي اريد اضافته")
end
...
return send(msg.chat_id_, msg.id_,"𖤓ارسل الان الكلمه لحذفها ")
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖤓تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖤓تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖤓تم حفظ الرد")
return false  
end  
end
if text then
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'افتار').." غادر" or text == 'غادر' then  
...
Text = '\n 𖤓 تم تفعيل الردود العامه' 
else
Text = '\n 𖤓 بالتاكيد تم تفعيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤓 تم تعطيل الردود العامه' 
else
Text = '\n 𖤓 بالتاكيد تم تعطيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/SO_AVT)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/SO_AVT)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/SO_AVT)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/SO_AVT)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/SO_AVT)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂𖤓](t.me/SO_AVT)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SO_AVT)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SO_AVT)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز يروحي 🌚❤️ ](t.me/SO_AVT)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/SO_AVT)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/SO_AVT)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/SO_AVT)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/SO_AVT)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/SO_AVT)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجعع تانيي مشحوار😹💃❤️](t.me/SO_AVT)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/SO_AVT)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/SO_AVT)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/SO_AVT)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/SO_AVT)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/SO_AVT)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/SO_AVT)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم ب ف ..🙄💔](t.me/SO_AVT)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/SO_AVT)') 
return false
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_AVT')..')'
local iduser = result.sender_user_id_
...
local sofi = ' 𖤓 عدد الادمنيه : '..data.administrator_count_..
'\n\n 𖤓 عدد المطرودين : '..data.kicked_count_..
'\n\n 𖤓 عدد الاعضاء : '..data.member_count_..
'\n\n 𖤓 عدد رسائل الجروب : '..(msg.id_/2097152/0.5)..
'\n\n 𖤓  اسم الجروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_,' 𖤓 عذرا لا استطيع طرد ادمنية الجروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' 𖤓 تم طردك من الجروب') 
...
if result.id_ then
send(msg.chat_id_, msg.id_,' 𖤓 😾تع يعم كلم الود دا قرفني [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 𖤓 هوا ابن الكلب دا الي ضافك😹» '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖤓 انت دخلت عبر الرابط يوسخ 🌝') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖤓 تم تعطيل امر  مين ضافني') 
end
end
...
Text = ' 𖤓 تم تفعيل امر مين ضافني '
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' 𖤓 بالتاكيد تم تفعيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤓 تم تعطيل امر مين ضافني '
else
Text = '\n 𖤓 بالتاكيد تم تعطيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = ' 𖤓 تم تفعيل امر اطردني إلى عايز يخرج يتنيل 😹'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' 𖤓 بالتاكيد تم تفعيل امر اطردني مخلاص كفايه تفعيل الأمر 😾'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n �