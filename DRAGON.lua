...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MADISON1110/risk/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1208165035,1660587162}   
...
if tonumber(user_d) == tonumber(1208165035) then  
var = true  
elseif tonumber(user_d) == tonumber(1660587162) then  
var = true  
...
var = 'مبرمج السورس'
elseif tonumber(user_id) == tonumber(1660587162) then  
var = 'مبرمج السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'الريسك'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
send(chat,msg.id_,"\n ☽ تم رفع الملف بنجاح وتفعيل الجروبات\n ☽ ورفع {الامنشئين الثانويين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
...
if DevSoFi(msg) then
local bl = '☉انت الان المطور الاساسي في البوت \n☉ سورس الريسك\n ☉يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/NIU_C)'
local keyboard = {
{'المبرمج ديبو','المبرمج ماديسون'},
...
os.execute('wget https://raw.githubusercontent.com/MADISON1110/risk/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'☽ تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☽ اصدار سورس الريسك{ s: 6.7}')
end

if text == 'ماديسون مبرمج السورس' then
local Text = [[
...
if #list == 0 then
t = "☽ لا يوجد مطورين الثانويين"
end
send(msg.chat_id_, msg.id_, t)
end
if text == ("مسح المطورين الثانويين") and SudoBot(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = SUDO},function(arg,result) 
 ...
 local msg_id = msg.id_/2097152/0.5
local Text = [[
تواصل مع مطور البوت عبر الازرار
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
send(msg.chat_id_, msg.id_,' الـجـروب مـفـعـل مـن قـبـل ياروحي 🌝💘')
else
sendText(msg.chat_id_,'\n ☽ بواسطه ⤌ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ☽ تـم تـفـعـيـل الـجـروب {'..chat.title_..'} 🌝💘',msg.id_/2097152/0.5,'md')
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ',url="t.me/AAHMEED11"},{text = ' ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ',url="t.me/liUI5I"}},
...
{
{text = '❨ 𝐌 𝐀 𝐃 𝐈 𝐒 𝐎 𝐍 ♬  ❩', url = "https://t.me/AAHMEED11"},
},
{
{text = '𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐑𝐢𝐬𝐤', url = "https://t.me/NIU_C"},
},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐨𝐮𝐫𝐜𝐞 𝐏𝐫𝐨𝐠𝐫𝐚𝐦𝐦𝐞𝐫𝐬', url="t.me/NIU_C"}}, 
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐈𝐒𝐊',url="t.me/E_H_M_BOT"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'ديبو' or text == 'المبرمج ديبو' or text == 'ديبو مبرمج السورس' or text == 'فين ديبو' then
local Text =[[


للتواصل مع ديبو مبرمج السورس
اتبع الازرار الاتيه♦️
...
{
{text = '❨ 𝐃 𝐄 𝐁 𝐎 ♬  ❩', url = "https://t.me/liUI5I"},
},
{
{text = '𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐑𝐢𝐬𝐤', url = "https://t.me/so_alfaa"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/liUI5I&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'فيكتوريا' or text == 'قلب ماديسون' or text == 'قمر ماديسون' or text =='وويويي' then
local Text =[[


للتواصل مع فيكتوريا لقمر 
اتبع الازرار الاتيه♦️
...
{
{text = '❨ 𝐕 𝐄 𝐂 𝐓 𝐎 𝐑 𝐈 𝐀 ♬  ❩', url = "https://t.me/Vecii_1122"},
},
{
{text = '𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐑𝐢𝐬𝐤', url = "https://t.me/NIU_C"},
},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Vecii_1122&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'كمال' or text == 'كوكي' or text == 'مرات ماديسون' or text =='وتكه ماديسون' then
local Text =[[


للتواصل مع مرات ماديسون
اتبع الازرار الاتيه♦️
...
{
{text = '❨ 𝐊 𝐀 𝐌 𝐀 𝐋 ♬  ❩', url = "https://t.me/G_X_W"},
},
{
{text = '𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐑𝐢𝐬𝐤', url = "https://t.me/NIU_C"},
},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/G_X_W&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس الريسك؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس الريسك؟ ", 
"كم مره حبيت؟ ", 
...
if text == "كتبات" or text == "حكمه" or text == "بوستات" then 
local TWEET_Msg = { 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❨ بوت التواصل ❩',url="t.me/E_H_M_BOT"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/M_S_U1/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[  
 ☾ اهلا في قائمه الالعاب المتطوره سورس الريسك ☾ 
...
{{text = '❨ 𝙎𝙊𝙐𝙍𝘾𝙀 𝐑𝐈𝐒𝐊 ❩', url="t.me/NIU_C"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
if tonumber(result.sender_user_id_) == tonumber(1660587162) then  
...
if result.id_ == tonumber(1660587162) then
...
if tonumber(userid) == tonumber(1660587162) then  
send(msg.chat_id_, msg.id_, " ☾ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MADISON1110/risk/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ☽ اهلا بك في متجر ملفات الريسك\n ☽ ملفات السورس ↓\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/MADISON1110/risk/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ☽ عذرا الملف لايدعم سورس الريسك\n") 
end
return false
end
...
if text == ("مسح قائمه الريسك") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ☽ تم مسح قائمه الريسك')
return false
end

if text == 'قائمه الريسك' and Sudo(msg) then
...
if text == ("رفع الريسك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع الريسك@(.*)$") and Sudo(msg) then
local username = text:match("^رفع الريسك@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع الريسك(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع الريسك(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل الريسك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل الريسك@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل الريسك@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل الريسك(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل الريسك(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
t = "☽ المنشئين الثانويين تعالو مخرب \n✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
-------------------
------------------------------------------------------------------------
if text == ("مسح الثانويين") and CoSu(msg) then
database:del(bot_id..'Basic:Constructor'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ☽ تم مسح المنشئين الثانويين')
return false
end
if text == 'المنشئين الثانويين' and CoSu(msg) then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
t = "\n ☽ قائمة المنشئين الثانويين \n✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if text == ("تاك للمنشئين الثانويين") or text == ("صيح المنشئين الثانويين") then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
t = "\n ☽ وينكم تعالو يريدوكم بالجروب \n✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
Reply_Status(msg,result.sender_user_id_,"reply","☽ تم تنزيله من المطور الثانويين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","☽ تم تنزيله من المطور الثانويين")  
else
send(msg.chat_id_, msg.id_,"☽ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","☽ تم تنزيله من المطور الثانويين")  
return false 
end
if text == ("المطورين الثانويين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
...
if text and text:match("^تنزيل مشرف كتمل @(.*)$") and BasicConstructor(msg) then
local username = text:match("^تنزيل مشرف @(.*)$")
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' ☽ البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'الريسك').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'الريسك')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
send(msg.chat_id_, msg.id_, 'بعتلك في الخاص يا روحي💘') 
local msg_id = msg.id_/2097152/0.5 
...
end --الكود حصري سورس الريسكيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'الريسك').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/NIU_C)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[عضو قميل 🌝💙](t.me/NIU_C)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[انت الخير ياعمري🌝💘](t.me/NIU_C)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[تم قفل التعريص بنجاح 😹😎](t.me/NIU_C)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجعع تانيي مشحوار😹💃❤️](t.me/NIU_C)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اوه ياه 🌝😂](t.me/NIU_C)') 
return false
end

if text == 'حبيبتيي' or text == 'حبيبتي' then
send(msg.chat_id_,msg.id_, '[اوعه ع الجمدان بقا حبيبتي وشغل عالي 🙈❤️](t.me/NIU_C)') 
return false
end

if text == 'طيب' or text == 'تيب' then
send(msg.chat_id_,msg.id_, '[فرح خالتك قريب😹💋💃🏻](t.me/NIU_C)') 
return false
end

if text == 'وه' or text == 'وهه' then
send(msg.chat_id_,msg.id_, '[بسيفلاح يعره مسمعش صوتكك??🙊](t.me/NIU_C)') 
return false
end

if text == 'اي' or text == 'ايي' then
send(msg.chat_id_,msg.id_, '[جتك اوهه م سامع ولا ايي😹👻](t.me/NIU_C)') 
return false
end

if text == 'نعم' or text == 'نعام' then
send(msg.chat_id_,msg.id_, '[نعم الله عليك🙂](t.me/NIU_C)') 
return false
end

if text == 'هه' or text == 'ههه' then
send(msg.chat_id_,msg.id_, '[ضحكه مش حلوه علفكره 😳😂](t.me/NIU_C)') 
return false
end

if text == 'بتحبنيي' or text == 'بتحبني' then
send(msg.chat_id_,msg.id_, '[وهو القمر ميتحبش ؟؟ ❤️😂](t.me/NIU_C)') 
return false
end

if text == '🙂' or text == '🙂💔' then
send(msg.chat_id_,msg.id_, '[بحبك متزعلش 😘💘](t.me/NIU_C)') 
end

if text == 'حبكك' or text == 'حبك' then
send(msg.chat_id_,msg.id_, '[حبككك اكترر ❤️](t.me/NIU_C)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[حصلخير اي هيجي منين الخير وانت هنا. 🙂😂](t.me/NIU_C)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[حصل حصوله 😹💜](t.me/NIU_C)') 
return false
end
end
end
...
if text == "المبرمج ماديسون" or text == 'فين ماديسون' then 
local function getpro(extra, result, success) 
if result.photos_[0] then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," ماديسون مبرمج السورس @AAHMEED11 ", msg.id_, msg.id_, "md") 
else 
send(msg.chat_id_, msg.id_,'ماديسون مبرمج السورس @AAHMEED11', 1, 'md') 
  end end 
...
send(msg.chat_id_, msg.id_,'المبرمج ديبو لو حابب تتواصل معاه اليوزر اهو  @liUI5I', 1, 'md') 
  end end 
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1660587162, offset_ = 0, limit_ = 1 }, getpro, nil) 
end
...
if text == "بوسها" and Sudo(msg) or text == 'بوسه' and Sudo(msg) then
...
send(msg.chat_id_,'['..t7fel[math.random(#t7fel)]..']') 
send(msg.chat_id_,'['..t7fel[math.random(#t7fel)]..']')   
send(msg.chat_id_, msg.reply_to_message_id_, 'امووووووح💋💋💋') 
send(msg.chat_id_, msg.id_, 'حصل يا مطوري ☺')  
return false 
end
if text == 'تفعيل الردود' and Manager(msg) then   
...
if text == 'بوت الحذف' or text == 'رابط حذف' or text == 'رابط الحذف' or text == 'بوت حذف' then
local Text = [[
مواقع مسح حسابات،🍂
...
☾صيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الثانويين
☾كشف القيود
☾تعين الايدي
☾تغير الايدي
☾الحساب + ايدي الحساب
...
☾مسح الثانويين ← المنشئين الثانويين
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'لعبه البات', url="https://t.me/NIU_C/10"},{text = 'لعبه الرياضيات',url="https://t.me/NIU_C/11"}},   
{{text = 'لعبه المختلف', url="https://t.me/NIU_C/16"},{text = 'لعبه السمايلات', url="https://t.me/NIU_C/17"}}, 
{{text = 'لعبه التخمين', url="https://t.me/NIU_C/20"},{text = 'لعبه العكس', url="https://t.me/NIU_C/19"}}, 
{{text = 'لعبه الاسرع', url="https://t.me/NIU_C/18"},{text = 'لعبه الانكليزي', url="https://t.me/NIU_C/14"}}, 
{{text = 'لعبه حزوره', url="https://t.me/NIU_C/13"},{text = 'لعبه المعاني', url="https://t.me/NIU_C/12"}}, 
{{text = 'لعبه الامثله', url="https://t.me/NIU_C/15"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐈𝐒𝐊', url="t.me/NIU_C"}},
{{text = 'القائمه الرائسيه🔙', callback_data="/add"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'الريسك')
