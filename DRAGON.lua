...
if res ~= 200 then
print('\27[0;31m≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sudo_users = {SUDO,1208165035,1829540452,1089386698,1654178416}   
...
var = true  
elseif tonumber(user_id) == tonumber(1089386698) then
var = true  
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'فولت'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "SO_VOL")
local NameUser = "𖣘 بواسطه » ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "𖣘 اسم المستخدم » ["..data.first_name_.."](T.me/"..UserName..")"
if status == "reply" then
send(msg.chat_id_, msg.id_,NameUserr.."\n"..text)
return false
end
else
send(msg.chat_id_, msg.id_,"𖣘 الحساب محذوف يرجى استخدام الامر بصوره صحيحه")
end
end,nil)   
end 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ")  
...
send(chat,msg.id_," 𖣘  ملف نسخه ليس لهاذا البوت")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
send(chat,msg.id_," 𖣘  جاري ...\n 𖣘  رفع الملف الان")
else
send(chat,msg.id_,"* 𖣘 عذرا الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح*")
end      
...
send(chat,msg.id_,"\n 𖣘 تم رفع الملف بنجاح وتفعيل الجروبات\n 𖣘 ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
local function trigger_anti_spam(msg,type)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
local Name = '['..utf8.sub(data.first_name_,0,40)..'](tg://user?id='..data.id_..')'
if type == 'kick' then 
Text = '\n 𖣘 العضــو » '..Name..'\n 𖣘 قام بالتكرار هنا وتم طرده '  
...
Text = '\n 𖣘 العضــو » '..Name..'\n 𖣘 قام بالتكرار هنا وتم تقييده '  
sendText(msg.chat_id_,Text,0,'md')
return false  
end  
if type == 'mute' then
Text = '\n 𖣘 العضــو » '..Name..'\n 𖣘 قام بالتكرار هنا وتم كتمه '  
sendText(msg.chat_id_,Text,0,'md')
database:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_) 
msgm = msg.id_
my_ide = msg.sender_user_id_
...
if text == "الغاء" or text == "الغاء 𖣘" then   
send(msg.chat_id_, msg.id_," 𖣘 تم الغاء الاذاعه")
...
send(msg.chat_id_, msg.id_," 𖣘 تمت الاذاعه الى *~ "..#list.." ~* جروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖣘 لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n  𖣘 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevSoFi(msg) then
local bl = ' 𖣘 اهلا عزيزي آلمـطـور\n 𖣘 آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n 𖣘 تسـتطـيع‌‏ آلتحگم باوامر البوت\n 𖣘 من خلاال الكيبورت خاص بك\n 𖣘 قناة سورس البوت [اضغط هنا](t.me/SO_VOL)'
local keyboard = {

{'الاحصائيات'},
{'مبرمجين السورس','قناة السورس'},
{'اضف رد عام','حذف رد عام'},
{'اضف رد متعدد','حذف رد متعدد'},
{'ضع اسم للبوت','المطور','الثانوين'},
...
SourceDRAGONr = '𖣘اهلا عزيزي\n𖣘انا بوت اسمي فولت\n𖣘اختصاصي حمايه الجروبات\n𖣘من تكرار والسبام والتوجيه والخ…\n𖣘لتفعيلي اتبع الاخطوات…↓\n𖣘اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[𖣘معرف المطور '
end 
...
send(msg.sender_user_id_, msg.id_,' 𖣘 تم ارسال رسالتك\n 𖣘 سيتم رد في اقرب وقت')
tdcli_function ({ID = "ForwardMessages", chat_id_ = SUDO,    from_chat_id_ = msg.sender_user_id_,    message_ids_ = {[0] = msg.id_},    disable_notification_ = 1,    from_background_ = 1 },function(arg,data) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,ta) 
vardump(data)
if data and data.messages_[0].content_.sticker_ then
local Name = '['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
local Text = ' 𖣘 تم ارسال الملصق من ↓\n - '..Name
...
local Text = ' 𖣘 المستخدم » '..Name..'\n 𖣘 تم حظره من التواصل'
...
Text = '\n 𖣘 تم تفعيل البوت الخدمي ' 
else
Text = '\n 𖣘 بالتاكيد تم تفعيل البوت الخدمي '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣘 تم تعطيل البوت الخدمي' 
else
Text = '\n 𖣘 بالتاكيد تم تعطيل البوت الخدمي'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text and database:get(bot_id..'Start:Bots') then
if text == 'الغاء' or text == 'الغاء' then   
send(msg.chat_id_, msg.id_,' 𖣘 الغاء حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,' 𖣘 تم حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'ضع كليشه ستارت ' and DevSoFi(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' 𖣘 ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ' and DevSoFi(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' 𖣘 تم حذف كليشه ستارت')
end
...
echo '*—————𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ——————~*\n𖣘✔{ الــدخــول } ⇎\n*»» '`whoami`'*'
echo '*—————𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ——————~*\n𖣘✔{ مـده تـشغيـل الـسـيـرفـر }⇎\n*»» '"$uptime"'*'
]]):read('*all'))  
end

if text == 'تحديث السورس ' and DevSoFi(msg) then 
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/MADISON1110/VOLTT/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' 𖣘 تم تحديث السورس \n 𖣘 لديك اخر اصدار لسورس فولت\n 𖣘 الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 𖣘 اصدار سورس فولت \n 𖣘 الاصدار »{ v 1.5}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/SO_VOL"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/SO_VOL)
]] 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩𝒕𝒘𝒂𝒔𝒐𝒍𓆪', url="t.me/E_H_M_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_," 𖣘 ارسل اليه الاسم الان ")
return false
end
...
Text = ' الاحصائيات 𖣘 \n'..' 𖣘 عدد الجروبات » {'..Groups..'}'..'\n 𖣘  عدد المشتركين » {'..Users..'}'
send(msg.chat_id_, msg.id_,Text) 
return false
end
...
send(msg.chat_id_, msg.id_," 𖣘 ارسل الان اذاعتك؟ \n 𖣘 للخروج ارسل الغاء ")
return false
end 
...
send(msg.chat_id_, msg.id_," 𖣘 ارسل لي التوجيه الان")
return false
end 
...
send(msg.chat_id_, msg.id_,'• اهلا بك عزيزي 𖣘 •\n• لايمكنك استخدام البوت 𖣘 •\n• عليك الاشتراك في القناة 𖣘 •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'𖣘 لا يوجد مشتركين وهميين في البوت \n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'𖣘 عدد المشتركين الان » ( '..#pv..' )\n𖣘 تم ازالة » ( '..sendok..' ) من المشتركين\n𖣘  الان عدد المشتركين الحقيقي » ( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'𖣘 لا يوجد جروبات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
DRAGON = '\n𖣘 تم ازالة » { '..q..' } جروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n𖣘 تم ازالة » {'..w..'} جروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'𖣘  عدد الجروبات الان » { '..#group..' }'..DRAGONk..''..DRAGON..'\n𖣘  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,' 𖣘 لا تستطيع استخدام البوت \n  𖣘 يرجى الاشتراك بالقناه اولا \n  𖣘 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
send(msg.chat_id_,msg.id_," 𖣘 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")
return false 
end      
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n 𖣘 العضو » ['..result.title_..'](t.me/'..(username or 'SO_VOL')..')'
status  = '\n 𖣘 تم ترقيته مطور'
texts = usertext..status
else
texts = ' 𖣘 لا يوجد حساب بهاذا المعرف'
end
...
usertext = '\n 𖣘 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..')'
status  = '\n 𖣘 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖣘 العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SO_VOL')..') \n 𖣘 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text == 'الغاء' or text == 'الغاء ' then   
send(msg.chat_id_, msg.id_," 𖣘 تم الغاء حفظ اسم البوت")
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
return false  
end 
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
database:set(bot_id..'Name:Bot',text) 
send(msg.chat_id_, msg.id_, " 𖣘 تم حفظ الاسم")
return false
end 
if database:get(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء 𖣘' then   
send(msg.chat_id_, msg.id_," 𖣘 تم الغاء الاذاعه للخاص")
...
send(msg.chat_id_, msg.id_," 𖣘 تمت الاذاعه الى >>{"..#list.."} مشترك في البوت ")
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 𖣘 تمت الاذاعه الى >>{"..#list.."} جروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 𖣘 تمت الاذاعه الى >>{"..#list.."} جروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_, " 𖣘 تم الغاء الامر ")
...
send(msg.chat_id_, msg.id_, ' 𖣘 المعرف لا يوجد فيه قناة')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, ' 𖣘 عذا لا يمكنك وضع معرف حسابات في الاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,' 𖣘 عذا لا يمكنك وضع معرف جروب بالاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,' 𖣘 البوت ادمن في القناة \n 𖣘 تم تفعيل الاشتراك الاجباري في \n 𖣘 ايدي القناة ('..data.id_..')\n 𖣘 معرف القناة ([@'..data.type_.channel_.username_..'])')
database:set(bot_id..'add:ch:id',data.id_)
database:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,' 𖣘 عذرآ البوت ليس ادمن بالقناه ')
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,' 𖣘 تم تغيير رسالة الاشتراك ')
end
...
send(msg.chat_id_, msg.id_,' 𖣘 … عذرآ البوت لايملك صلاحيات')
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,' 𖣘 تم تغيير صورة الجروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 𖣘 تم الغاء وضع الوصف")
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
https.request('https://api.telegram.org/bot'..token..'/setChatDescription?chat_id='..msg.chat_id_..'&description='..text) 
send(msg.chat_id_, msg.id_,' 𖣘 تم تغيير وصف الجروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 𖣘 تم الغاء حفظ الترحيب")
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id..'Get:Welcome:Group'..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,' 𖣘 تم حفظ ترحيب الجروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == 'الغاء' then
send(msg.chat_id_,msg.id_," 𖣘 تم الغاء حفظ الرابط")
...
send(msg.chat_id_,msg.id_," 𖣘 تم حفظ الرابط بنجاح")
database:del(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
...
send(msg.chat_id_,0," 𖣘 العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 𖣘 ["..DRAGON_Msg.."] \n")
else
send(msg.chat_id_,0," 𖣘 العضو : {["..data.first_name_.."](T.ME/SO_VOL)}\n 𖣘 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, " 𖣘 عذرا » {[@"..data.username_.."]}\n 𖣘 عذرا تم منع الملصق \n" ) 
else
send(msg.chat_id_,0, " 𖣘 عذرا » {["..data.first_name_.."](T.ME/SO_VOL)}\n 𖣘 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' 𖣘 عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSoFi(msg) then
send(msg.chat_id_, msg.id_,' 𖣘 عدد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖣘 بالتأكيد تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n 𖣘 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖣘 تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = ' 𖣘 تم تفعيل جروب جديده\n'..
'\n 𖣘 بواسطة {'..Name..'}'..
'\n 𖣘 ايدي الجروب {'..IdChat..'}'..
'\n 𖣘 اسم الجروب {['..NameChat..']}'..
'\n 𖣘 عدد اعضاء الجروب *{'..NumMember..'}*'..
'\n 𖣘 الرابط {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_,' 𖣘 بالتأكيد تم تعطيل الجروب')
else
sendText(msg.chat_id_,'\n 𖣘 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖣘 تم تعطيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖣘 تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n 𖣘 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖣘 تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' 𖣘 تم تعيين عدد الاعضاء سيتم تفعيل الجروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
if text == 'تحديث السورس' and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
send(msg.chat_id_, msg.id_, ' 𖣘 حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSoFi(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖣘 حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك " and DevSoFi(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " 𖣘 تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك 𖣘$") and DevSoFi(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖣘 حسنآ ارسل لي معرف القناة')
return false  
end
...
send(msg.chat_id_, msg.id_," 𖣘 الاشتراك الاجباري مفعل \n 𖣘 على القناة » ["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_," 𖣘 اهلا عزيزي المطور \n 𖣘 ارسل الان معرف قناتك")
end
return false  
end
...
send(msg.chat_id_, msg.id_, " 𖣘 تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري " and DevSoFi(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " 𖣘 تم تفعيل الاشتراك الاجباري \n 𖣘 على القناة » ["..addchusername.."]")
else
send(msg.chat_id_, msg.id_, " 𖣘 لا يوجد قناة في الاشتراك الاجباري ")
end
return false  
end
if text == "تفعيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, '𖣘 تم تفعيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "تعطيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, '𖣘 تم تعطيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
send(msg.chat_id_, msg.id_, '𖣘 تم كتم الاسم '..BlNe)
...
send(msg.chat_id_, msg.id_, '𖣘 تم الغاء كتم الاسم '..delBn)
...
texts = "𖣘 تم مسح الاسماء المكتومه "
send(msg.chat_id_, msg.id_, texts)
end
...
t = "\n𖣘 قائمة الاسماء المكتومه \n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫ \n"
for k,v in pairs(All_name) do
t = t..""..k.."- (["..v.."])\n"
end
if #All_name == 0 then
t = "𖣘 لا يوجد اسماء مكتومه"
end
send(msg.chat_id_, msg.id_, t)
end
end
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddS0FI:stats") == "✔" then
send(msg.chat_id_, msg.id_, '𖣘 تم التفعيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_, '𖣘 تم تعطيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_,'𖣘 تم تعيين '..teh..' كتوحيد للمجموعه')
...
send(msg.chat_id_, msg.id_,'𖣘 تم تعين  '..nump..' عدد الكتم')
...
send(msg.chat_id_, msg.id_, '𖣘 تم تعطيل التوحيد')
...
send(msg.chat_id_, msg.id_, "𖣘 عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "SO_VOL")..")\n𖣘 عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."} بجانب اسمك\n𖣘 عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local Text = [[
𓆩✶𓆪 𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝐬𝐨𝐮𝐫𝐜𝐞 𝐯𝐨𝐥𝐭, 𝐭𝐡𝐞 𝐛𝐞𝐬𝐭 𝐬𝐨𝐮𝐫𝐜𝐞 𝐨𝐧 𝐭𝐞𝐥𝐞𝐠𝐫??𝐦 𖡨 𓆩✶𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𖣘 𝐃𝐞𝐯 𝐁𝐚𝐧𝐝𝐚 𖣘 ',url="t.me/uu_1_p"}},
{{text = '𖣘 𝐃𝐞𝐯 𝐌𝐚𝐝𝐢𝐬𝐨𝐧 𖣘',url="t.me/AAHMEED11"}},
{{text = '𖣘 𝐃𝐞𝐯 𝐍𝐚𝐝𝐞𝐫 𖣘', url="t.me/Nader_almarg"}},
{{text = '𖣘 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭  𖣘', url="t.me/SO_VOL"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[
𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐋𝐓 𖣘
𖣘اهلا بك في سورس فولت الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني 𖣘
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩𝐃𝐄𝐕 𝐁𝐀𝐍𝐃𝐀𓆪',url="t.me/uu_1_p"}},
{{text = '𓆩𝐃𝐄𝐕 𝐌𝐀𝐃𝐈𝐒𝐎𝐍𓆪',url="t.me/AAHMEED11"}},
{{text = '𓆩𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐎𝐋𝐓𓆪',url="t.me/SO_VOL"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'باندا' or text == 'احمد باندا' or text == 'بندا' then
local Text = [[
آتبع الازرار للتواصل مع مبرمج السورس ♡
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'ماديسون' or text == 'احمد'or text == 'مبرمج السورس' then
local Text = [[
...
if text == 'نادر' or text == 'نادر المرج' or text == 'مطور السورس' then
local Text = [[
للتواصل مع مطور السورس اتبع الازرار ♡
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'مبرمجين السورس' or text == 'مطورين السورس' or text == 'احنا المطورين' then
local Text = [[
للتواصل مع مبرمجين السورس 
اتبع الازار الي تحت⬇️
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐔𝐬𝐞𝐫 𝐕𝐨𝐥𝐭', url="t.me/US_VOL"}}, 
{{text = '𝐃𝐞𝐯 𝐌𝐚𝐝𝐢𝐬𝐨𝐧',url="t.me/AAHMEED11"}},
{{text = '𝐃𝐞𝐯 𝐁𝐚𝐧𝐝𝐚',url="t.me/uu_1_p"}},
{{text = '𝐃𝐞𝐯 𝐍𝐚𝐝𝐞𝐫',url="t.me/Nader_almarg"}},
{{text = '𝐔𝐬𝐞𝐫 𝐕𝐨𝐥𝐭', url="t.me/US_VOL"}}, 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[ققناة مطورين سورس فولت♡](t.me/US_VOL)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐔𝐬𝐞𝐫 𝐕𝐨𝐥𝐭', url="t.me/US_VOL"}}, 
...
"‏ علينا إحياء زَمن الرّسائل الورقيّة وسط هذه الفوضى الالكترونية العَارمة.𖣘💜",
...
"‏ من مراتب التعاسه إطالة الندم ع شيء إنتهى. 𖣘 ",
...
local TWEET_Msg = { 
"نصيحه ضيف جهاتك هنا عشان تاخد مشرف😂♥",
"الجمال يلفت الأنظار لكن الطيبه تلفت القلوب ", 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭', url="t.me/E_H_M_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[ 
[كاوبس مبرمج سورس فولت ♡(t.me/G_W_P)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐃𝐞𝐯 𝐄𝐥𝐤𝐚𝐛𝐨𝐬', url="t.me/G_W_P"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'العاب فولت' then
local Text = [[
𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 
]]
...
{{text = '𓆩𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 𓆪', url="t.me/SO_VOL"}}, 
}  
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
send(msg.chat_id_, msg.id_,' 𖣘 تم ازالة جميع الاوامر المضافه')  
end
end
...
send(msg.chat_id_, msg.id_,' 𖣘 ارسل الامر القديم')  
return false
end
...
send(msg.chat_id_, msg.id_,' 𖣘 ارسل الامر الذي قمت بوضعه بدلا عن القديم')  
return false
end
end
if text and database:get(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
database:set(bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,' 𖣘 ارسل الامر الجديد')  
...
send(msg.chat_id_, msg.id_,' 𖣘 تم حفظ الامر')  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 𖣘 بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SO_VOL')..') \n 𖣘 تـم قفـل الدردشه ')
end,nil)   
...
Text = ' 𖣘 تم تفعيل نسبه الحب'
database:del(bot_id..'Cick:lov'..msg.chat_id_)  
else
Text = ' 𖣘 بالتاكيد تم تفعيل نسبه الحب'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣘 تم تعطيل نسبه الانوثه'
else
Text = '\n 𖣘 بالتاكيد تم تعطيل نسبه الانوثه'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل all' and CoSu(msg) then   
if database:get(bot_id..'Cick:all'..msg.chat_id_) then
Text = ' 𖣘 تم تفعيل امر @all'
database:del(bot_id..'Cick:all'..msg.chat_id_)  
else
Text = ' 𖣘 بالتاكيد تم تفعيل امر @all'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,' 𖣘 تم قفل التكرار بالطرد')
elseif text == 'قفل التكرار' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'del')  
send(msg.chat_id_, msg.id_,' 𖣘 تم قفل التكرار')
elseif text == 'قفل التكرار بالتقييد' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'keed')  
send(msg.chat_id_, msg.id_,' 𖣘 تم قفل التكرار بالتقييد')
elseif text == 'قفل التكرار بالكتم' and Mod(msg) then 
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'mute')  
send(msg.chat_id_, msg.id_,' 𖣘 تم قفل التكرار بالكتم')
elseif text == 'فتح التكرار' and Mod(msg) then 
database:hdel(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood")  
send(msg.chat_id_, msg.id_,' 𖣘 تم فتح التكرار')
end
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevSoFi(msg) then    
dofile('DRAGON.lua')  
send(msg.chat_id_, msg.id_, ' 𖣘 تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevSoFi(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n 𖣘 تم مسح قائمه العام')
return false
end
if text == ("قائمه العام") and DevSoFi(msg) then
local list = database:smembers(bot_id..'GBan:User')
t = "\n 𖣘 قائمة المحظورين عام \n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
send(msg.chat_id_, msg.id_, " 𖣘 لا يمكنك حظر المطور الاساسي \n")
return false 
end
if result.sender_user_id_ == tonumber(1208165035) then
send(msg.chat_id_, msg.id_, " 𖣘 لا يمكنك حظر مبرمج السورس\n")
return false 
end
if result.sender_user_id_ == tonumber(1829540452) then
send(msg.chat_id_, msg.id_, " 𖣘 لا يمكنك حظر مالك السورس\n")
return false 
end
if result.sender_user_id_ == tonumber(1089386698) then
send(msg.chat_id_, msg.id_, " 𖣘 لا يمكنك حظر مطور السورس\n")
return false 
end
if result.sender_user_id_ == tonumber(1654178416) then
send(msg.chat_id_, msg.id_, " 𖣘 لا يمكنك حظر مطور السورس\n")
return false  
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖣘 لا تسطيع حظر البوت عام")
return false 
end
...
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, " 𖣘 لا يمكنك كتم المطور الاساسي \n")
return false 
end
if result.sender_user_id_ == tonumber(1208165035) then
send(msg.chat_id_, msg.id_, " 𖣘 لا يمكنك كتم مبرمج السورس\n")
return false 
end
if result.sender_user_id_ == tonumber(1829540452) then
send(msg.chat_id_, msg.id_, " 𖣘 لا يمكنك كتم مالك السورس\n")
return false 
end
if result.sender_user_id_ == tonumber(1089386698) then
send(msg.chat_id_, msg.id_, " 𖣘 لا يمكنك كتم مطور السورس\n")
return false 
end
if result.sender_user_id_ == tonumber(1654178416) then
send(msg.chat_id_, msg.id_, " 𖣘 لا يمكنك كتم مطور السورس\n")
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖣘 لا تسطيع كتم البوت عام")
return false 
end
...
usertext = '\n 𖣘 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..')'
status  = '\n 𖣘 تم الغاء (الحظر-الكتم) عام من الجروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
send(msg.chat_id_, msg.id_, "\n 𖣘 تم مسح قائمة المطورين  ")
end
if text == ("المطورين") and DevSoFi(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n 𖣘 قائمة مطورين البوت \n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if Get_info then
local TextS = "\n 𖣘 اهلا بك في متجر ملفات فولت\n 𖣘 ملفات السورس ↓\n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n 𖣘 علامة تعني { ✔️ } ملف مفعل\n 𖣘 علامة تعني { ✖ } ملف معطل\n 𖣘 قناة سورس فولت ↓\n".." 𖣘 [اضغط هنا لدخول](t.me/SO_VOL) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 𖣘 لا يوجد اتصال من ال api \n") 
end
return false
end
end
...
t = " 𖣘 بالتاكيد تم تعطيل ملف → "..file.."\n"
end
...
send(msg.chat_id_, msg.id_," 𖣘 عذرا الملف لايدعم سورس فولت \n") 
end
return false
end
...
if file_bot then
io.close(file_bot)
t = " 𖣘 بالتاكيد تم تفعيل ملف → "..file.." \n"
else
t = " 𖣘 الملف » "..file.."\n 𖣘 تم تفعيل ملف \n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/black801/Bak/main/File_Bot/"..file)
...
send(msg.chat_id_,msg.id_," 𖣘 تم مسح الملفات")
return false
end
...
send(msg.chat_id_, msg.id_,' 𖣘 لا ����ستطيع استخدام البوت \n  𖣘 يرجى الاشتراك بالقناه اولا \n  𖣘 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
function start_function(extra, result, success)
...
if text == ("مسح قائمه فولت") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖣘 تم مسح قائمه فولت')
return false
end

if text == 'قائمه فولت' and Sudo(msg) then
...
if #list == 0 then
t = " 𖣘 لا يوجد احد في قائمه المالك"
end
send(msg.chat_id_, msg.id_, t)
end

if text == ("رفع فولت") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع فولت @(.*)$") and Sudo(msg) then
local username = text:match("^رفع فولت @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع فولت (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع فولت (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل فولت") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل فولت @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل فولت @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل فولت (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل فولت (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
t = "𖣘 المنشئين الاساسين تعالو مخرب \n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = "𖣘 ماكو منششئين يشوفولك جاره"
end
Reply_Status(msg,msg.sender_user_id_,"reply","𖣘 قام بنشر ملصق اباحيه\n"..t)  
...
Reply_Status(msg,msg.sender_user_id_,"reply","𖣘 قام بنشر صوره اباحيه\n"..t)  
DeleteMessage(msg.chat_id_,{[0] = tonumber(msg.id_),msg.id_})   
end   
end
...
Text = ' 𖣘 بالتاكيد تم تفعيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣘 تم تعطيل امر تحويل'
else
Text = '\n 𖣘 بالتاكيد تم تعطيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_, '\n 𖣘 تم مسح المنشئين الاساسين')
return false
end
if text == 'المنشئين الاساسين' and CoSu(msg) then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
t = "\n 𖣘 قائمة المنشئين الاساسين \n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
send(msg.chat_id_, msg.id_," 𖣘 حساب المنشئ محذوف")
return false  
end
local UserName = (b.username_ or "SRC-DRAGON")
send(msg.chat_id_, msg.id_," 𖣘 منشئ الجروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
Reply_Status(msg,result.sender_user_id_,"reply","𖣘 تم ترقيته مطور ثانوي في البوت")  
end
...
Reply_Status(msg,result.id_,"reply","𖣘 تم ترقيته مطور ثانوي في البوت")  
else
send(msg.chat_id_, msg.id_,"𖣘 لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖣘 تم ترقيته مطور ثانوي في البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖣘 تم تنزيله من المطور ثانويين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","𖣘 تم تنزيله من المطور ثانويين")  
else
send(msg.chat_id_, msg.id_,"𖣘 لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖣘 تم تنزيله من المطور ثانويين")  
return false 
end
if text == ("الثانويين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
t = "\n𖣘 قائمة مطورين الثانويين للبوت \n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," 𖣘 لا يوجد ادمنيه ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_," 𖣘 تمت ترقيه { "..num2.." } من الادمنيه") 
end
end,nil)   
end
if text == 'مسح الادمنيه' and Manager(msg) then
database:del(bot_id..'Mod:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖣘 تم مسح الادمنيه')
end
...
send(msg.chat_id_, msg.id_,' 𖣘 تم تعطيل الرفع') 
return false
end
...
send(msg.chat_id_, msg.id_, ' 𖣘 تم مسح المنظفين')
end
...
send(msg.chat_id_, msg.id_,' 𖣘 تم تعطيل الطرد') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖣘 لا تسطيع طرد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖣘 عذرا لا تستطيع طرد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' 𖣘  ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖣘 البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..')'
...
send(msg.chat_id_, msg.id_, '\n 𖣘 عذرا لا تستطيع طرد ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⚠| عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
send(msg.chat_id_, msg.id_, '\n 𖣘 عذرا لا تستطيع طرد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, ' 𖣘 تم مسح المميزين')
end
if text == ("المميزين") and Mod(msg) then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n 𖣘 قائمة مميزين الجروب \n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖣘 لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..')'
status  = '\n 𖣘 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖣘 العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, ' 𖣘 تم مسح جميع المتوحدين')
end
if text == ("تاك للمتوحدين") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n 𖣘 قائمة متوحدين الجروب \n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖣘 تم رفع العضو متوحد في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..')'
status  = '\n 𖣘 تم تنزيل العضو متوحد في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣘 تم مسح جميع الزوجات')
end
if text == ("تاك للزوجات") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n 𖣘 قائمه زوجات الجروب \n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖣘 تم رفع العضــو زوجه في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..')'
status  = '\n 𖣘 تم تنزيل العضــو الزوجات من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣘 تم مسح جميع الكلاب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖣘 تم رفع العضــو كلب في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..')'
status  = '\n 𖣘 تم تنزيل العضــو كلب من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣘 تم تنزيل جميع حمير من الجروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..')'
local  statuss  = '\n 𖣘 تم رفع المتهم حمار بالجروب\n 𖣘 الان اصبح حمار الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣘 تم تنزيل جميع وتكات الجروب')
end
if text == ("تاك للوتكات") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n 𖣘 قائمة وتكات الجروب \n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' 𖣘 تم تنزيل جميع القرده بالجروب')
end
if text == ("تاك للقرود") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n 𖣘 قائمة القرود الجروب \n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..')'
local  statuss  = '\n 𖣘 تم رفع قرد في الجروب\n 𖣘 تعال حبي استلم موزه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣘 تم تنزيل جميع البقرات بالجروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n 𖣘 قائمة البقرات الجروب \n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..')'
local  statuss  = '\n 𖣘 تم رفع بقره في الجروب\n 𖣘 ها يالهايشه تع احلبك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..')'
status  = '\n 𖣘 تم تنزيل بقره من الجروب\n 𖣘 تعال هاك حليب مالتك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣘 تم تنزيل جميع المزز بالجروب')
end
...
send(msg.chat_id_, msg.id_, ' 𖣘 تم تنزيل جميع االاكساس')
end
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 𖣘 تم تعطيل الحظر') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖣘 لا تسطيع حظر البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖣘 عذرا لا تستطيع حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if result.id_ then
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖣘 عذرا لا تستطيع حظر ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 𖣘 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
usertext = '\n 𖣘  المستخدم » ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n 𖣘 تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖣘 عذرا لا تستطيع حظر ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' 𖣘 ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, ' 𖣘 انا لست محظورآ \n') 
return false 
end
...
send(msg.chat_id_, msg.id_, ' 𖣘 تم مسح المكتومين')
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖣘 لا تسطيع كتم البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖣘 عذرا لا تستطيع كتم ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖣘 البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖣘 عذرا لا تستطيع كتم ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 𖣘 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..')'
status  = '\n 𖣘 تم كتم لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖣘 عذرا لا تستطيع كتم ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖣘 البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖣘 لا تسطيع تقيد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖣘 عذرا لا تستطيع تقيد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖣘 عذرا لا تستطيع تقيد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..')'
status  = '\n 𖣘 تم تقيده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n 𖣘 عذرا لا تستطيع تقيد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..')'
status  = '\n 𖣘  الايدي » `'..result.sender_user_id_..'`\n 𖣘  تم رفعه مشرف '
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..')'
status  = '\n 𖣘  الايدي » `'..result.sender_user_id_..'`\n 𖣘  تم تنزيله ادمن من الجروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
'\n𝙶𝚁𝙾𝚄𝙿 𝚂𝙴𝚃𝚃𝙸𝙽𝙶𝚂'..
'\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ '..
'\n 𖣘 اعدادات الجروب كتالي √↓'..
'\nء≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫'..
'\n 𖣘  علامة ال {🔓} تعني مفعل'..
'\n 𖣘  علامة ال {🔐} تعني معطل'..
'\nء≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫'..
'\n 𖣘  الروابط » { '..lock_links..
' }\n'..' 𖣘  المعرفات » { '..lock_user..
' }\n'..' 𖣘  التاك » { '..lock_hash..
' }\n'..' 𖣘  البوتات » { '..lock_bots..
' }\n'..' 𖣘  التوجيه » { '..lock_fwd..
' }\n'..' 𖣘  التثبيت » { '..lock_pin..
' }\n'..' 𖣘  الاشعارات » { '..lock_tagservr..
' }\n'..' 𖣘  الماركدون » { '..lock_mark..
' }\n'..' 𖣘  التعديل » { '..lock_edit..
' }\n'..' 𖣘  تعديل الميديا » { '..lock_edit_med..
' }\nء≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫'..
'\n'..' 𖣘  الكلايش » { '..lock_spam..
' }\n'..' 𖣘  الكيبورد » { '..lock_inlin..
' }\n'..' 𖣘  الاغاني » { '..lock_vico..
' }\n'..' 𖣘  المتحركه » { '..lock_gif..
' }\n'..' 𖣘  الملفات » { '..lock_file..
' }\n'..' 𖣘  الدردشه » { '..lock_text..
...
' }\n'..' 𖣘  التكرار » { '..flood..
' }\n'..' 𖣘  الترحيب » { '..welcome..
' }\n'..' 𖣘  عدد التكرار » { '..NUM_MSG_MAX..
' }\nء≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫'..
'\n 𖣘  علامة ال {🔓} تعني مفعل'..
'\n 𖣘  علامة ال {🔐} تعني معطل'..
'\nء≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫'..
'\n'..' 𖣘  امر صيح » { '..kickme..
' }\n'..' 𖣘  امر اطردني » { '..sehuser..
' }\n'..' 𖣘  امر منو ضافني » { '..addme..
' }\n'..' 𖣘  الردود » { '..rdmder..
' }\n'..' 𖣘  الردود العامه » { '..rdsudo..
' }\n'..' 𖣘  الايدي » { '..idgp..
' }\n'..' 𖣘 الايدي بالصوره » { '..idph..
' }\n'..' 𖣘  الرفع » { '..setadd..
-- ' }\n'..' 𖣘  الحظر » { '..banm..' }\n\n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n 𖣘 قناة سورس فولت ↓\n [ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ](t.me/SO_VOL) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_," 𖣘 عذرآ تم قفل التثبيت")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖣘 تم تثبيت الرساله")   
database:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_," 𖣘 انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_," 𖣘 لا توجد رساله مثبته")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖣘 ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
end
end,nil) 
end
...
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_,msg.id_," 𖣘 عذرآ تم قفل الثبيت")  
return false  
end
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖣘 تم الغاء تثبيت الرساله")   
...
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"𖣘 تم الغاء تثبيت الكل")   
...
send(msg.chat_id_,msg.id_," 𖣘 حسنآ ارسل اليه الرابط الان")
...
send(msg.chat_id_, msg.id_," 𖣘 تم تعطيل الرابط") 
return false end
end
...
send(msg.chat_id_, msg.id_," 𖣘 تم تفعيل الصوره") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖣘 تم تعطيل الصوره") 
return false end
end
 if text == "الرابط" then 
...
linkgp = ' 𖣘 لا يوجد رابط ارسل ضع رابط'
end  
...
send(msg.chat_id_,msg.id_," 𖣘 تم مسح الرابط")           
...
send(msg.chat_id_, msg.id_,' 𖣘 ارسل لي الصوره') 
return false
end
...
send(msg.chat_id_, msg.id_,' 𖣘 تم ازالة صورة الجروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖣘 ارسل الان الوصف')
end
return false  
end
...
t  = ' 𖣘 ارسل لي الترحيب الان'
tt = '\n 𖣘 تستطيع اضافة مايلي !\n 𖣘 دالة عرض الاسم »{`name`}\n 𖣘 دالة عرض المعرف »{`user`}'
...
GetWelcome = ' 𖣘 لم يتم تعيين ترحيب للجروب'
end 
...
send(msg.chat_id_, msg.id_,' 𖣘 تم تفعيل ترحيب الجروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖣘 تم تعطيل ترحيب الجروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' 𖣘 تم ازالة ترحيب الجروب') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then       
send(msg.chat_id_, msg.id_," 𖣘 ارسل الكلمه لمنعها")  
...
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," 𖣘 ارسل التحذير عند ارسال الكلمه")  
...
if test == "repp" then  
send(msg.chat_id_, msg.id_," 𖣘 تم منع الكلمه مع التحذير")  
...
send(msg.chat_id_, msg.id_," 𖣘 ارسل الكلمه الان")  
database:set(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_," 𖣘 تم الغاء منعها")  
database:del(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
send(msg.chat_id_, msg.id_," 𖣘 تم مسح قائمه المنع")  
end
...
send(msg.chat_id_,msg.id_,' 𖣘 تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'TEXT_SUDO',text)
database:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' 𖣘 تم حفظ كليشة المطور')
return false
end
-----------------
...
send(msg.chat_id_, msg.id_, ' 𖣘 تم ازالة كليشة الايدي')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 𖣘 تم الغاء تعين الايدي") 
...
send(msg.chat_id_, msg.id_,' 𖣘 تم تعين الايدي')    
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " 𖣘 لا توجد بوتات في الجروب")
else
local t = ' 𖣘 عدد البوتات هنا >> {'..c..'}\n 𖣘 عدد البوتات التي هي ادمن >> {'..x..'}\n 𖣘 تم طرد >> {'..(c - x)..'} من البوتات'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == i then 
local a = '\n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n 𖣘 عدد البوتات التي هنا >> {'..n..'} بوت\n'
local f = ' 𖣘 عدد البوتات التي هي ادمن >> {'..t..'}\n 𖣘 ملاحضه علامة ال (𖣘) تعني ان البوت ادمن \n'
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, " 𖣘 تم الغاء حفظ القوانين") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_," 𖣘 تم حفظ قوانين الجروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_," 𖣘 ارسل لي القوانين الان")  
end
end
if text == 'مسح القوانين' or text == 'حذف القوانين' then  
if Mod(msg) then
send(msg.chat_id_, msg.id_," 𖣘 تم ازالة قوانين الجروب")  
...
send(msg.chat_id_, msg.id_," 𖣘 لا توجد قوانين")   
end    
end
...
send(msg.chat_id_, msg.id_,' 𖣘 تم طرد المحذوفين')
end,nil)
end
end
...
if #list == 0 then
send(msg.chat_id_, msg.id_,' 𖣘 لا توجد صلاحيات مضافه')
return false
end
t = "\n 𖣘 قائمة الصلاحيات المضافه \n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_, " 𖣘 ارسل نوع الرتبه \n 𖣘 {عـضـو -- ممـيـز -- ادمـن -- مـديـر}") 
end
...
send(msg.chat_id_, msg.id_, "* 𖣘 تم مسح الصلاحيه *\n") 
end
...
if text == 'مدير' then
if not Constructor(msg) then
send(msg.chat_id_, msg.id_"* 𖣘 تستطيع اضافه صلاحيات {ادمن - مميز - عضو} \n 𖣘 ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'ادمن' then
if not Manager(msg) then 
send(msg.chat_id_, msg.id_,"* 𖣘 تستطيع اضافه صلاحيات {مميز - عضو} \n 𖣘 ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'مميز' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,"* 𖣘  تستطيع اضافه صلاحيات {عضو} \n 𖣘 ارسل الصلاحيه مجددا*\n") 
return false
end
end
...
send(msg.chat_id_, msg.id_, " 𖣘 تـم اضـافـه الامـر") 
database:del(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖣘 العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SO_VOL')..')'..'\n 𖣘 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,' 𖣘 تم مسح رسائلك'  )  
...
send(msg.chat_id_, msg.id_,' 𖣘 عدد رسائلك » { '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'𖣘تستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,'𖣘 تم حذف {'..num..'}')  
...
send(msg.chat_id_, msg.id_,"𖣘 تم تنظيف جميع الميديا")
end
...
local Message = v
if Message then
t = "𖣘 تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."S00F4:allM"..msg.chat_id_)
end
end
if #list == 0 then
t = "𖣘 لا يوجد ميديا في المجموعه"
end
send(msg.chat_id_, msg.id_, t)
end
...
local numl = v
if numl then
l = "𖣘 عدد الميديا الموجود هو "..k
end
end
if #num == 0 then
l = "𖣘 لا يوجد ميديا في المجموعه"
end
...
send(msg.chat_id_, msg.id_,'𖣘 تم تنظيف جميع الرسائل المعدله')
end
...
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," 𖣘 ارسل لي الاسم الان ")  
end
return false
end
...
if text == "بوت" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'فولت')
local DRAGON_Msg = {
...
send(msg.chat_id_, msg.id_,' 𖣘 الاذاعه معطله من قبل المطور الاساسي')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖣘 ليست لدي صلاحية تغير اسم الجروب")  
else
sebd(msg.chat_id_,msg.id_,' 𖣘 تم تغيير اسم الجروب الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_,"𖣘 لا تستطيع تنزيل المطور الاساسي")
return false 
end
...
send(msg.chat_id_, msg.id_,"\n𖣘 تم تنزيل الشخص من الرتب التاليه \n𖣘  { "..dev..""..crr..""..cr..""..own..""..mod..""..mn..""..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n𖣘  عذرا العضو لايملك رتبه \n")
end
...
send(msg.chat_id_, msg.id_," 𖣘 تم مسح الردود العامه")
end

if text == ("الردود العامه") and DevSoFi(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n 𖣘 قائمة الردود العامه \n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' 𖣘 تم حفظ الرد')
return false  
end  
end
if text and text:match("^(.*)$") then
if database:get(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,' 𖣘 ارسل الرد الذي تريد اضافته')
...
send(msg.chat_id_, msg.id_,' 𖣘 تم ازالة الرد العام')
...
send(msg.chat_id_, msg.id_,' 𖣘 ارسل الكلمه تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' 𖣘 ارسل الكلمه تريد حذفها')
...
send(msg.chat_id_, msg.id_,"𖣘 تم حذف الرد من ردود المتعدده")
...
send(msg.chat_id_, msg.id_,"𖣘تم حذف ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_," 𖣘 تم مسح الردود")
end
...
send(msg.chat_id_, msg.id_,' 𖣘 تم ازالة الرد ')
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,' 𖣘 ارسل الكلمه التي تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' 𖣘 ارسل الكلمه التي تريد حذفها')
...
send(msg.chat_id_, msg.id_,'𖣘لا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\n 𖣘قم بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n𖣘 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..') '
status  = '\n𖣘 الايدي » '..result.sender_user_id_..'\n𖣘تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖣘 البوت ليس مشرف يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..')'
status  = '\n 𖣘  الايدي » `'..result.sender_user_id_..'`\n 𖣘  تم حذف لقبه من الجروب'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
send(msg.chat_id_, msg.id_,'𖣘وينك وين القب ') 
else
send(msg.chat_id_, msg.id_,'𖣘لقبك هو : '..GeId.result.custom_title) 
end
end
...
send(msg.chat_id_, msg.id_,'\n 𖣘صلاحيات البوت هي\n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n𖣘  علامة ال {✔️} تعني مفعل\n𖣘  علامة ال {✖} تعني غير مفعل\n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n𖣘تغير معلومات المجموعة ↞ '..INf..'\n𖣘حذف الرسائل ↞ '..DEL..'\n𖣘حظر المستخدمين ↞ '..REs..'\n𖣘دعوة المستخدمين ↞ '..INv..'\n𖣘ثتبيت الرسالة ↞ '..Pin..'\n𖣘اضافة مشرفين ↞ '..PRo)   
end
end
if text == "تعطيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_, '⌯ تم تعطيل الانستا')
database:set(bot_id.."SO_VOL:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."SO_VOL:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."SO_VOL:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."SO_VOL:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"𖣘تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."SO_VOL:Tag:Admins:"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "𖣘تم تعطيل تاك المشرفين")
end

if text == 'صيح المشرفين' or text == "تاك للمشرفين" or text == "وين المشرفين" or text == "المشرفين" then
if database:get(bot_id.."SO_VOL:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس فولت يعني لو بكتهن راح اعرفك انت الاخذتهن
local t = "\n𖣘المستخدم ~ ["..User_id .."] يصيح المشرفين \n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n"
k = 0
...
return send(msg.chat_id_, msg.id_,"𖣘ارسل الرد الذي اريد اضافته")
end
...
return send(msg.chat_id_, msg.id_,"𖣘ارسل الان الكلمه لحذفها ")
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖣘تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖣘تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖣘تم حفظ الرد")
return false  
end  
end
if text then
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فولت').." غادر" or text == 'غادر' then  
...
Text = ' 𖣘 تم تفعيل مغادرة البوت'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = ' 𖣘 بالتاكيد تم تفعيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and DevSoFi(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = ' 𖣘 تم تعطيل مغادرة البوت'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = ' 𖣘 بالتاكيد تم تعطيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n 𖣘 تم تفعيل الردود العامه' 
else
Text = '\n 𖣘 بالتاكيد تم تفعيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣘 تم تعطيل الردود العامه' 
else
Text = '\n 𖣘 بالتاكيد تم تعطيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣘 تم تفعيل الايدي بالصور' 
else
Text = '\n 𖣘 بالتاكيد تم تفعيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣘 تم تعطيل الايدي بالصوره' 
else
Text = '\n 𖣘 بالتاكيد تم تعطيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,' 𖣘 ايديه ~⪼ '..iduser..'\n 𖣘 معرفه ~⪼ '..username..'\n 𖣘 رتبته ~⪼ '..rtp..'\n 𖣘 تعديلاته ~⪼ '..edit..'\n 𖣘 نقاطه ~⪼ '..NUMPGAME..'\n 𖣘 جهاته ~⪼ '..Contact..'\n 𖣘 رسائله ~⪼ '..Msguser..'')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' 𖣘 المعرف غير صحيح ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' 𖣘 رتبتك في البوت » '..rtp)
end
if text == 'انا مين' and SudoBot(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/SO_VOL)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/SO_VOL)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/SO_VOL)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/SO_VOL)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/SO_VOL)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂𖣘](t.me/SO_VOL)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SO_VOL)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SO_VOL)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز يروحي 🌚❤️ ](t.me/SO_VOL)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[عضو قميل 😉](t.me/SO_VOL)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/SO_VOL)') 
return false
end

if text == 'حصل' or text == 'حص' then
send(msg.chat_id_,msg.id_, '[حصل حصوله😂🎶](t.me/SO_VOL)') 
return false
end

if text == 'صلي علي الحبيب' or text == 'محمد عليه السلام' then
send(msg.chat_id_,msg.id_, '[عليه افضل الصلاة والسلام 💙📿](t.me/SO_VOL)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[تدوم الضحكه يا روحي 🌝❤](t.me/SO_VOL)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/SO_VOL)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/SO_VOL)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/SO_VOL)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجعع تانيي مشحوار😹💃❤️](t.me/SO_VOL)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/SO_VOL)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/SO_VOL)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/SO_VOL)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/SO_VOL)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/SO_VOL)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/SO_VOL)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم ب ف ..🙄💔](t.me/SO_VOL)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/SO_VOL)') 
return false
end
end
end
...
first_name = ' 𖣘 اسمك الاول » {`'..(result.first_name_)..'`}'
else
first_name = ''
end   
if result.last_name_ then 
last_name = ' 𖣘 اسمك الثاني » {`'..result.last_name_..'`}' 
else
last_name = ''
end      
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,' 𖣘 ايديك » '..msg.sender_user_id_)
end
if text == 'الرتبه' and tonumber(msg.reply_to_message_id_) > 0 then
function start_function(extra, result, success)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_VOL')..')'
local iduser = result.sender_user_id_
...
local username = ('[@'..data.username_..']' or 'لا يوجد')
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,' 𖣘 الايدي » ('..iduser..')\n 𖣘 المعرف » ('..username..')\n 𖣘 الرتبه » ('..rtp..')\n 𖣘 نوع الكشف » بالرد')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_,msg.id_," 𖣘 البوت ليس ادمن \n") 
return false  
end 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
local sofi = ' 𖣘 عدد الادمنيه : '..data.administrator_count_..
'\n\n 𖣘 عدد المطرودين : '..data.kicked_count_..
'\n\n 𖣘 عدد الاعضاء : '..data.member_count_..
'\n\n 𖣘 عدد رسائل الجروب : '..(msg.id_/2097152/0.5)..
'\n\n 𖣘  اسم الجروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_, '\n 𖣘 عذرا لا استطيع طرد ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )')
return false
end
...
send(msg.chat_id_, msg.id_,' 𖣘 عذرا لا استطيع طرد ادمنية الجروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' 𖣘 تم طردك من الجروب') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,' 𖣘 تم تعطيل امر اطردني') 
end
end
...
send(msg.chat_id_, msg.id_,' 𖣘 المعرف غلط ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
send(msg.chat_id_, msg.id_,' 𖣘 لا استطيع اصيح معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' 𖣘 لا استطيع اصيح معرف بوتات') 
return false  
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,' 𖣘 😾تع يعم كلم الود دا قرفني [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' 𖣘 تم تعطيل امر صيح') 
end
return false
end
...
send(msg.chat_id_, msg.id_,' 𖣘 انت منشئ الجروب') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 𖣘 هوا ابن الكلب دا الي ضافك😹» '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖣘 انت دخلت عبر الرابط يوسخ 🌝') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖣘 تم تعطيل امر  مين ضافني') 
end
end
...
Text = ' 𖣘 تم تفعيل امر مين ضافني '
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' 𖣘 بالتاكيد تم تفعيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣘 تم تعطيل امر مين ضافني '
else
Text = '\n 𖣘 بالتاكيد تم تعطيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل صيح' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = ' 𖣘 تم تفعيل امر صيح'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = ' 𖣘 بالتاكيد تم تفعيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣘 بالتاكيد تم تعطيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = ' 𖣘 تم تفعيل امر اطردني إلى عايز يخرج يتنيل 😹'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' 𖣘 بالتاكيد تم تفعيل امر اطردني مخلاص كفايه تفعيل الأمر 😾'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣘 تم تعطيل امر اطردني اترزع هن بقى مفيش خروج 😹'
else
Text = '\n 𖣘 بالتاكيد تم تعطيل امر اطردني مفيش خروج يولاد الكلب 😹'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖣘 الصوره معطله") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 𖣘 عدد صورك ~⪼ "..result.total_count_.." صوره‌‏", msg.id_, msg.id_, "md")
else
...
send(msg.chat_id_, msg.id_,'𖣘 تم تغير الايدي ارسل ايدي لرؤيته')
end
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, sofi.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n- 𝐔𝐒𝐄𝐑𝐍𝐀𝐌𝐄 𖣘  '..username..'\n 𖣘- 𝐌𝐒𝐆𝐒  '..Msguser..'\n 𖣘 - 𝐒𝐓𝐀𝐓𝐒  '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 𖣘 - 𝐘𝐎𝐔𝐑.𝐈𝐃 '..msg.sender_user_id_..'\n- 𝐂𝐇 𖣘 @SO_VOL\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n- 𝐔𝐒𝐄??𝐍𝐀𝐌𝐄 𖣘  '..username..'\n 𖣘- 𝐌𝐒𝐆𝐒  '..Msguser..'\n 𖣘 - 𝐒𝐓𝐀𝐓𝐒  '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 𖣘 - 𝐘𝐎𝐔𝐑.𝐈𝐃 '..msg.sender_user_id_..'\n- 𝐂𝐇 𖣘 @SO_VOL\n')
else
send(msg.chat_id_, msg.id_, '\n 𖣘 الصوره ~⪼ ليس لديك صور في حسابك'..'[\n- 𝐔𝐒𝐄𝐑𝐍𝐀𝐌𝐄 𖣘  '..username..'\n 𖣘- 𝐌𝐒𝐆𝐒  '..Msguser..'\n 𖣘 - 𝐘𝐎𝐔𝐑.𝐈𝐃 '..msg.sender_user_id_..'\n- 𝐂𝐇 𖣘 @SO_VOL\n')
end 
end
end
else
...
if Num == 0 then 
Text = ' 𖣘  ليس لديك سحكات'
else
Text = ' 𖣘 عدد سحكاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "مسح سحكاتي" or text == "حذف سحكاتي" then  
send(msg.chat_id_, msg.id_,' 𖣘 تم مسح سحكاتك'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "حذف جهاتي" then  
send(msg.chat_id_, msg.id_,' 𖣘 تم مسح جهاتك'  )  
...
if Num == 0 then 
Text = ' 𖣘 لم تقم بأضافه احد'
else
Text = ' 𖣘 عدد جهاتك *» { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تنظيف المشتركين" and DevSoFi(msg) then 
...
-- vardump(data) 
DRAGONdx(msg.chat_id_, msg.id_, ' 𖣘 ايدي المجموعة » ( '..msg.chat_id_..' )\n 𖣘 عدد الادمنيه » ( *'..data.administrator_count_..' )*\n 𖣘 عدد المحظورين » ( *'..data.kicked_count_..' )*\n 𖣘 عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_," 𖣘 تم اضافة له {"..numadded..'} من الرسائل')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,  1, "𖣘| تم اضافة له {"..numadded..'} من النقود', 1 , 'md')  
end
------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' 𖣘 ارسل لي عدد الرسائل الان') 
return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' 𖣘 ارسل لي عدد النقاط التي تريد اضافتها') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_," 𖣘 تم اضافة له {"..Num..'} من النقاط')  
end
...
if Num == 0 then 
Text = ' 𖣘 لم تلعب اي لعبه للحصول على نقاط'
else
Text = ' 𖣘 عدد نقاطك التي ربحتها هيه *» { '..Num..' } نقاط *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n* 𖣘 لا استطيع البيع اقل من 1 *") 
return false 
end
if tonumber(database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,' 𖣘 ليس لديك نقاط في الالعاب\n 𖣘 اذا كنت تريد ربح نقاط \n 𖣘 ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n 𖣘 ليس لديك نقاط في هذه لعبه \n 𖣘 لزيادة نقاطك في اللعبه \n 𖣘 ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
send(msg.chat_id_,msg.id_,' 𖣘 تم خصم *» { '..NUMPY..' }* من نقاطك \n 𖣘 وتم اضافة* » { '..(NUMPY * 50)..' } رساله الى رسالك *')
end 
return false 
end
...
send(msg.chat_id_,msg.id_,'\n 𖣘 اهلا عزيزي البوت هنا ادمن'..'\n 𖣘 وصلاحياته هي ↓ \nٴ━━━━━━━━━━'..'\n 𖣘 تغير معلومات الجروب ↞ ❴ '..info..' ❵'..'\n 𖣘 حذف الرسائل ↞ ❴ '..delete..' ❵'..'\n 𖣘 حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n 𖣘 دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n 𖣘 تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n 𖣘 اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
send(msg.chat_id_, msg.id_," 𖣘 تم تغير رد المطور الى » "..Teext)
end
...
send(msg.chat_id_, msg.id_, ' 𖣘 تم استعادة الاوامر القديمه')
end
if text == 'تغير امر الاوامر' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_, ' 𖣘 الان يمكنك ارسال الكليشه الاوامر')
database:set(bot_id..'help'..msg.sender_user_id_,'true')
return false 
end
if text == 'تغير امر ⓵' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_, ' 𖣘 الان يمكنك ارسال الكليشه ⓵')
...
send(msg.chat_id_, msg.id_,'𖣘لا تستطيع استخدام البوت \n 𖣘يرجى الاشتراك بالقناه اولا \n 𖣘اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
local Text =[[
...
اوامر سورس فولت الاوامر خاصه ب الادمن 🕹️
[𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ](t.me/SO_VOL)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 𖣘 هاذا الامر خاص بالادمنيه\n 𖣘 ارسل {⑩} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local MRSoOoFi = database:get(bot_id.."AL:AddS0FI:stats") or "لم يتم التحديد"
...
send(msg.chat_id_, msg.id_, t..'━━━━━━\nاضغط علي الاسم ليتم نسخه\n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n 𖣘[𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ](t.me/SO_VOL)𖣘 ')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, '𖣘 تم تعطيل الابراج')
database:set(bot_id.." sofi:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'𖣘 تم تفعيل الابراج')
...
send(msg.chat_id_, msg.id_, '𖣘 تم تعطيل حساب العمر')
...
send(msg.chat_id_, msg.id_,'𖣘 تم تفعيل حساب العمر')
...
local notText = '✪هاذا الامر خاص بالادمنيه
...
keyboard.inline_keyboard = {
{
{text = '𖣘 اوامر الوضع 𖣘', callback_data="/help3"},
},
{
{text = '𖣘 اوامر التنزيل والرفع 𖣘', callback_data="/help4"},
},
{
{text = '𖣘 اوامر المطورين 𖣘', callback_data="/help5"},
},
{
{text = '𖣘 اوامر الأعضاء 𖣘', callback_data="/help6"},
},
{
{text = '𖣘 اوامر التسليه 𖣘', callback_data="/help7"},
},
{
{text = '⌯ 𖣘 قفل و القفل 𖣘 ⌯', callback_data="/help"},
},
{
{text = '𖣘 تعطيل و تفعيل 𖣘', callback_data="/help2"},
},
}
...
{
{text = '𖣘 قفل و القفل 𖣘', callback_data="/help1"},
},
{
{text = '⌯ 𖣘 تعطيل و تفعيل 𖣘 ⌯', callback_data="/help"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
𖣘امسح
𖣘صلاحيه
𖣘 قائمه منع المتحركات
𖣘قائمه منع الصور
𖣘قائمه منع الملصقات
𖣘 مسح قائمه المنع
𖣘 المحذوفين
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
𖣘 مسح  امر + الامر القديم  
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
𖣘 الاوامر المضافه ( لعرض الاوامر المضافه ) 
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
[𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ](t.me/SO_VOL)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '⌯ 𖣘 اوامر الوضع 𖣘 ⌯', callback_data="/help"},
},
{
{text = '𖣘 اوامر التنزيل والرفع 𖣘', callback_data="/help4"},
},
...
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
𖣘 استعاده الاوامر 
𖣘 تحويل كالاتي  بالرد على صوره او ملصق او صوت او بصمه بالامر ← تحويل 
𖣘 صيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين
𖣘كشف القيود
𖣘تعين الايدي
𖣘تغير الايدي
𖣘 الحساب + ايدي الحساب
𖣘مسح + العدد
𖣘تنزيل الكل
𖣘تنزيل جميع الرتب
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
...
𖣘الصور + متحركه + ملصق 
𖣘حظر ~ كتم ~ تقيد ~ طرد
𖣘المحظورين ~ المكتومين ~ المقيدين
𖣘 الغاء كتم + حظر + تقيد ~ بالرد و معرف و ايدي
 𖣘تقيد ~ كتم + الرقم + ساعه
𖣘تقيد ~ كتم + الرقم + يوم
𖣘تقيد ~ كتم + الرقم + دقيقه
𖣘تثبيت ~ الغاء تثبيت
𖣘 الترحيب
𖣘الغاء تثبيت الكل
𖣘 كشف البوتات
𖣘الصلاحيات
𖣘 كشف برد ← بمعرف ← ايدي
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
𖣘تاك للكل
𖣘 وضع لقب + لقب
𖣘 مسح لقب بالرد
...
{
{text = '𖣘 اوامر التنزيل والرفع 𖣘', callback_data="/help"},
},
{
{text = '𖣘 اوامر المطورين 𖣘', callback_data="/help5"},
},
...
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
𖣘 تفعيل ← تعطيل 
𖣘المجموعات ← المشتركين ← الاحصائيات
𖣘رفع ← تنزيل منشئ اساسي
𖣘مسح الاساسين ← المنشئين الاساسين
𖣘مسح المنشئين ← المنشئين
𖣘 اسم ~ ايدي + بوت غادر 
𖣘اذاعه 
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺ 
𖣘 اوامر مطور الاساسي
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
𖣘تفعيل
𖣘تعطيل
𖣘مسح الاساسين
𖣘المنشئين الاساسين
𖣘 رفع/تنزيل منشئ اساسي
𖣘 رفع/تنزيل مطور اساسي 
𖣘 مسح المطورين
𖣘 المطورين
𖣘 رفع | تنزيل مطور
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
...
𖣘قائمه العام
𖣘 مسح قائمه العام
𖣘 جلب نسخه الاحتياطيه
𖣘 رفع نسخه الاحتياطيه
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
𖣘اذاعه خاص
𖣘اذاعه
𖣘اذاعه بالتوجيه
𖣘 اذاعه بالتوجيه خاص
𖣘اذاعه بالتثبيت
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
𖣘جلب نسخه البوت
𖣘رفع نسخه البوت
𖣘ضع عدد الاعضاء + العدد
𖣘ضع كليشه المطور
𖣘 تفعيل/تعطيل الاذاعه
𖣘تفعيل/تعطيل البوت الخدمي
𖣘تفعيل/تعطيل التواصل
𖣘تغير اسم البوت
𖣘اضف/مسح رد عام
𖣘الردود العامه
𖣘مسح الردود العامه
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
𖣘الاشتراك الاجباري
𖣘تعطيل الاشتراك الاجباري
𖣘تفعيل الاشتراك الاجباري
𖣘مسح رساله الاشتراك
𖣘تغير رساله الاشتراك
𖣘تغير الاشتراك
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
𖣘الاحصائيات
𖣘المشتركين
𖣘المجموعات 
𖣘تفعيل/تعطيل المغادره
𖣘مسح الجروبات
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
[𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ](t.me/SO_VOL)
]]
...
{
{text = '⌯ 𖣘 اوامر المطورين 𖣘 ⌯', callback_data="/help"},
},
{
{text = '𖣘 اوامر الأعضاء 𖣘', callback_data="/help6"},
},
...
𖣘مصه بالرد
𖣘رزله بالرد 
𖣘شنو رئيك بهذا بالرد
𖣘شنو رئيك بهاي بالرد
𖣘تحب هذا
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
[𖣘 𝐒𝐨𝐮??𝐜𝐞 𝐕𝐨𝐥𝐭 𖣘 ](t.me/SO_VOL)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '⌯ 𖣘 اوامر الأعضاء 𖣘 ⌯', callback_data="/help"},
},
{
{text = '𖣘 اوامر التسليه 𖣘', callback_data="/help7"},
},
...
𖣘 اوامر التسليه 𖣘 
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
    𖣘 اوامر جديده ومميزه  ↓
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
𖣘 اكتب ❪ باد ❫ واستمتع 
😹  بالاسئله المحرجه 
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
𖣘  اكتب ❪ بوستات ❫ واستمتع 
🌚❤️ بالبوستات العظيمه
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
𖣘 رفع + تنزيل ← الامࢪ ↓
⩹━━━━━━ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━⩺
...
{
{text = ' 𖣘 اوامر التسليه 𖣘 ', callback_data="/help"},
},
{
{text = '𖣘 قفل و القفل 𖣘', callback_data="/help1"},
},
...
{
{text = ' 𖣘 التنزيل والرفع 𖣘', callback_data="/help4"},
},
{
{text = '𖣘 اوامر المطورين 𖣘', callback_data="/help5"},
},
...
send(msg.chat_id_, msg.id_,' 𖣘 تم حذف الامر')  
else
send(msg.chat_id_, msg.id_,' 𖣘 لا يوجد امر بهاذا الاسم')  
end
...
send(msg.chat_id_, msg.id_, ' 𖣘 تم تعطيل اوامر التسليه')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التسليه") then 
send(msg.chat_id_, msg.id_, '  𖣘 تم تفعيل اوامر التسليه')
database:del(bot_id.."Fun_Bots:"..msg.chat_id_)
end
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فولت')
...
send(msg.chat_id_,0,''..t..'\n≪━━━━━━𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭 ━━━━━━≫\n 𖣘 تم التعديل على الميديا\n 𖣘 الشخص الي قام بالتعديل\n 𖣘 ايدي الشخص ◂ '..result.sender_user_id_..'\n 𖣘 معرف الشخص»{ '..users..' }') 
end,nil)
...
--local curl = 'curl "'..'https://api.telegram.org/bot1564973291:AAF2IwSno-EITmF3sGz40dGXKVNKNaUn0wI/sendDocument'..'" -F "chat_id='.. 1208165035 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
...
if DRAGON1_Msg then    
send(msg.chat_id_, msg.id_," 𖣘 "..DRAGON1_Msg)
