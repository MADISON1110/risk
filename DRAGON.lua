...
if res ~= 200 then
print('\27[0;31mღ═───═𝙁𝘼𝙍𝙒𝙇𝘼═───═ღ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naღ═───═𝙁𝘼𝙍𝙒𝙇𝘼═───═ღ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mღ═───═𝙁𝘼𝙍𝙒𝙇𝘼═───═ღ\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sudo_users = {SUDO,1610557559,1753323063,1871247255,1557685494,1745864543}   
...
var = true
elseif tonumber(user_id) == tonumber(1871247255) then
var = true
elseif tonumber(user_id) == tonumber(1745864543) then
var = true
...
if text == 'بويكا' or text == 'مالك السورس' or text == 'بويكا مبرمج السورس' or text == 'بويكا التاني' then
local Text =[[
...
{
{text = '𝐷𝑒𝑣 𝐵𝑜𝑦𝑘𝑎', url = "https://t.me/ha_rr_y_ha_ma"},
},
{
{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙁𝘼𝙍𝙒𝙇𝘼 ❈', url = "https://t.me/frawla2021"},
},
...
if text == 'تاكي' or text == 'مطور السورس' or text == 'تاكي مطور السورس' or text == 'الشيخ تاكي' then
local Text =[[
...
{
{text = '𝐷𝑒𝑣 𝑇𝑎𝑘𝑦', url = "https://t.me/Dad_taky"},
},
{
{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙁𝘼𝙍𝙒𝙇𝘼 ❈' url = "https://t.me/frawla2021"},
},
...
if text == 'قناه السورس' or text == 'قناة السورس' or text == 'قنااه السورس' or text =='الهقر' then
local Text =[[
...
{
{text = '𝑺𝒐𝒖𝒓𝒄𝒆 𝑷𝒓𝒐𝒈𝒓𝒂𝒎𝒎𝒆𝑟𝑠', url = "https://t.me/US_FARA"},
},
{
{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙁𝘼𝙍𝙒𝙇𝘼 ❈', url = "https://t.me/frawla2021"},
},
...
if text == 'بوت تواصل' or text == 'بوت التواصل' or text == 'تواصل السورس' or text =='الهقر' then
local Text =[[
...
{
{text = '𝑺𝒐𝒖𝒓𝒄𝒆 𝑷𝒓𝒐𝒈𝒓𝒂𝒎𝒎𝒆𝒔', url = "https://t.me/US_FARA"},
},
{
{text = '( 𝐓 𝐖 𝐀 𝐒 𝐎 𝐋 )', url = "https://t.me/frawla2021"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'فراوله' or text == 'سورس' or text == 'السورس' or text == 'source' or text == 'يا سورس' or text == 'FARAWLA' then 
local msg_id = msg.id_/2097152/0.5  
local Text = [[ 
╭──── ● ☆ ● ────╮
☆
...
keyboard = {}  
keyboard.inline_keyboard = {
{{text = '  ❨ 𝐷𝑒𝑣 𝐵𝑜𝑦𝑘𝑎',url="t.me/ha_rr_y_ha_ma"},{text = ' 𝐷𝑒𝑣 𝑇𝑎𝑘𝑦  ❩ ',url="t.me/Dad_taky"}},
{{text = '  ❨ 𝑺𝑶𝑼𝑹𝑪𝑬 𝙁𝘼𝙍𝙒𝙇𝘼 ❩ ',url="https://t.me/frawla2021"}}, 
}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/frawla2021&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[
  ♬ اهلا بك في سورس فراوله لو عايز بوت بأسعار منسبه وبوت مميز كلمني
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨ 𝐷𝑒𝑣 𝐵𝑜𝑦𝑘𝑎',url="t.me/ha_rr_y_ha_ma"},{text = ' 𝐷𝑒𝑣 𝑇𝑎𝑘𝑦  ❩ ',url="t.me/Dad_taky"}},
{{text = '  ❨  ♬ 𝐓𝐄𝐀𝐒𝐎𝐋   ♬  ❩ ',url="t.me/boyka03_bot "}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'بويكا' or text == 'المبرمج بويكا' or text == 'بويكا التاني' or text =='الهقر' then
local Text =[[
...
if text == 'تاكي' or text == 'تاكي مبرمج السورس' or text == 'الشبخ تاكي' or text =='الهقر' then
local Text =[[
...
if text == 'نيني' or text == 'ويوي' then
local Text = [[
...
if tonumber(result.sender_user_id_) == tonumber(1871247255) then  
...
if tonumber(result.sender_user_id_) == tonumber(1745864543) then  
send(msg.chat_id_, msg.id_, " ღ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if result.id_ == tonumber(1871247255) then
send(msg.chat_id_, msg.id_, " ღ لا تسطيع حظر مطور السورس عام \n")
return false 
end
if result.id_ == tonumber(1557685494) then
send(msg.chat_id_, msg.id_, " ღ لا تسطيع حظر مطور السورس عام \n")
return false 
end
if result.id_ == tonumber(1745864543) then
send(msg.chat_id_, msg.id_, " ღ لا تسطيع حظر مطور السورس عام \n")
return false 
end
...
if tonumber(userid) == tonumber(1871247255) then  
send(msg.chat_id_, msg.id_, " ღ لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(userid) == tonumber(1557685494) then  
send(msg.chat_id_, msg.id_, " ღ لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(userid) == tonumber(1745864543) then  
send(msg.chat_id_, msg.id_, " ღ لا تسطيع حظر مطور السورس عام")
return false 
end
...
Reply_Status(msg,userid,"reply","ღ تم ترقيته مطور ثانوي ف البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","ღ تم تنزيله من المطور الثانوي")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","ღ تم تنزيله من المطور الثانوي")  
else
send(msg.chat_id_, msg.id_,"ღ لا يوجد حساب بهاذا المعرف")
end
end
